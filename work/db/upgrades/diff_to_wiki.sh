...
svn diff kfs/tags/releases/release-3-0-1 kfs/trunk --summarize > difference_summary.txt
# strip the url prefix
perl -pi -e 's@kfs/tags/releases/release-3-0-1/@kfs/@g' difference_summary.txt
