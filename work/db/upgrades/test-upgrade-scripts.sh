...
ORACLE_TEST_DB_URL=${ORACLE_TEST_DB_URL:-jdbc:oracle:thin:@localhost:1521:ORCL}
#MYSQL_TEST_DB_URL=jdbc:mysql://localhost:3306
...
if [[ "$PERFORM_COMPARISON" == "true" ]]; then
	...
	cp $PROJECT_DIR/work/db/kfs-db/demo/schema.xml $WORKSPACE/new_schema.xml
	popd
