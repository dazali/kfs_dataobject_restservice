...
(
      CRDT_MEMO_ID DECIMAL(9)
        ...
        , CRDT_MEMO_STAT_CD VARCHAR(4)
        , CRDT_MEMO_NBR VARCHAR(35) NOT NULL
        ...
        , ACCT_DISTR_MTD_IND VARCHAR(1) default 'P'
...
(
      PMT_RQST_ID DECIMAL(9)
        ...
        , PMT_RQST_CST_SRC_CD VARCHAR(4) NOT NULL
...
(
    ...
    , INDEX AR_NON_INV_DIST_TI2 (FDOC_REF_NBR)
...
(
      CA_A21_ICR_ACCT_GNRTD_ID DECIMAL(10)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , FIN_COA_CD VARCHAR(2)
        , ACCOUNT_NBR VARCHAR(7)
...
(
      KC_UNIT VARCHAR(8)
        ...
        , ACCT_CLOSED_IND VARCHAR(1)
        , ACCT_DFLT_ID DECIMAL(22)
    
    , CONSTRAINT CA_ACCT_AUTO_CREATE_DFLT_TP1 PRIMARY KEY(ACCT_DFLT_ID)
...
(
    ...
    , INDEX CA_OBJECT_CODE_TI2 (FIN_COA_CD, FIN_OBJ_LEVEL_CD)
    , INDEX CA_OBJECT_CODE_TI3 (FIN_OBJ_SUB_TYP_CD)
    , INDEX CA_OBJECT_CODE_TI4 (FIN_OBJ_TYP_CD)
    , INDEX CA_OBJECT_CODE_TI5 (UNIV_FISCAL_YR)
...
(
    ...
    , INDEX CA_PRIOR_YR_ACCT_TI10 (ACCT_MGR_UNVL_ID)
    , INDEX CA_PRIOR_YR_ACCT_TI11 (ACCT_SPVSR_UNVL_ID)
    , INDEX CA_PRIOR_YR_ACCT_TI2 (ACCOUNT_NBR, FIN_COA_CD)
    , INDEX CA_PRIOR_YR_ACCT_TI3 (ACCT_TYP_CD)
    , INDEX CA_PRIOR_YR_ACCT_TI4 (FIN_HGH_ED_FUNC_CD)
    , INDEX CA_PRIOR_YR_ACCT_TI5 (FIN_COA_CD, ORG_CD)
    , INDEX CA_PRIOR_YR_ACCT_TI6 (ACCT_RSTRC_STAT_CD)
    , INDEX CA_PRIOR_YR_ACCT_TI7 (SUB_FUND_GRP_CD)
    , INDEX CA_PRIOR_YR_ACCT_TI8 (ACCT_FSC_OFC_UID)
    , INDEX CA_PRIOR_YR_ACCT_TI9 (ACCT_PHYS_CMP_CD)
...
(
      CA_PRIOR_YR_ICR_ACCT_GNRTD_ID DECIMAL(10)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , FIN_COA_CD VARCHAR(2)
        , ACCOUNT_NBR VARCHAR(7)
...
(
    ...
    , INDEX CA_SUB_OBJECT_CD_TI2 (UNIV_FISCAL_YR)
...
(
    ...
    , INDEX CG_AWD_ORG_TI2 (CGPRPSL_NBR)
...
# CG_CFDA_REF_T
# -----------------------------------------------------------------------
drop table if exists CG_CFDA_REF_T
/
...
(
    ...
    , CONSTRAINT CG_CFDA_REF_TP1 PRIMARY KEY(CG_CFDA_NBR)
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , CPTLAST_ALLOC_AMT DECIMAL(19,2) default 0
        , CPTLAST_ALLOC_VAL DECIMAL(19,2)
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , AST_PMT_DST_CD VARCHAR(1) default '2'
        , AST_PMT_DIST_CD_FROM_FP_IND VARCHAR(1) default 'N'
...
(
      AST_PMT_DST_CD VARCHAR(1)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , AST_PMT_DST_NM VARCHAR(40)
        , AST_PMT_DST_COL_NM VARCHAR(40)
        , AST_PMT_DST_EDT VARCHAR(1)
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , YEAR_END_DEPR_DTL_ACTV_IND VARCHAR(1) default 'Y'
        , YEAR_END_DEPR_DTL_PROC_IND VARCHAR(1) default 'N'
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        ...
        , YEAR_END_DEPR_ACTV_IND VARCHAR(1) default 'Y'
...
# END_ACRL_MTHD_T
# -----------------------------------------------------------------------
drop table if exists END_ACRL_MTHD_T
/

CREATE TABLE END_ACRL_MTHD_T
(
      SEC_ACRL_MTHD VARCHAR(1)
        , SEC_ACRL_MTHD_DESC VARCHAR(150) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_ACRL_MTHD_TP1 PRIMARY KEY(SEC_ACRL_MTHD)
...
# -----------------------------------------------------------------------
drop table if exists END_AGRMNT_SPCL_INSTRC_CD_T
/

CREATE TABLE END_AGRMNT_SPCL_INSTRC_CD_T
(
      AGRMNT_SPCL_INSTRC_CD VARCHAR(3)
        , AGRMNT_SPCL_INSTRC_DESC VARCHAR(75) NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_AGRMNT_SPCL_INSTRC_CD_TP1 PRIMARY KEY(AGRMNT_SPCL_INSTRC_CD)
...
# -----------------------------------------------------------------------
drop table if exists END_AGRMNT_STAT_CD_T
/

CREATE TABLE END_AGRMNT_STAT_CD_T
(
      AGRMNT_STAT_CD VARCHAR(4)
    ...
    , CONSTRAINT END_AGRMNT_STAT_CD_TP1 PRIMARY KEY(AGRMNT_STAT_CD)
...
# END_AGRMNT_TYP_CD_T
# -----------------------------------------------------------------------
drop table if exists END_AGRMNT_TYP_CD_T
/

CREATE TABLE END_AGRMNT_TYP_CD_T
(
      AGRMNT_TYP_CD VARCHAR(3)
        , AGRMNT_TYP_CD_DESC VARCHAR(75) NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_AGRMNT_TYP_CD_TP1 PRIMARY KEY(AGRMNT_TYP_CD)
...
# -----------------------------------------------------------------------
drop table if exists END_AUTO_CSH_INVEST_MDL_T
/

CREATE TABLE END_AUTO_CSH_INVEST_MDL_T
(
      ACI_MDL_ID DECIMAL(9)
        ...
        , ACI_MDL_DT DATETIME NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , ACI_NXT_DUE_DT DATETIME
    
    , CONSTRAINT END_AUTO_CSH_INVEST_MDL_TP1 PRIMARY KEY(ACI_MDL_ID)
...
# END_AVAIL_CSH_T
# -----------------------------------------------------------------------
drop table if exists END_AVAIL_CSH_T
/
...
(
    ...
    , CONSTRAINT END_AVAIL_CSH_TP1 PRIMARY KEY(KEMID)
...
# END_CAE_CD_T
# -----------------------------------------------------------------------
drop table if exists END_CAE_CD_T
/
...
(
      CAE_CD VARCHAR(1)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , CAE_TYP VARCHAR(1) NOT NULL
    
    , CONSTRAINT END_CAE_CD_TP1 PRIMARY KEY(CAE_CD)
...
# END_CLOSE_CD_T
# -----------------------------------------------------------------------
drop table if exists END_CLOSE_CD_T
/
...
(
    ...
    , CONSTRAINT END_CLOSE_CD_TP1 PRIMARY KEY(CLOSE_CD)
...
# END_CLS_CD_T
# -----------------------------------------------------------------------
drop table if exists END_CLS_CD_T
/
...
(
    ...
    , CONSTRAINT END_CLS_CD_TP1 PRIMARY KEY(SEC_CLS_CD)
...
# END_CLS_CD_TYP_T
# -----------------------------------------------------------------------
drop table if exists END_CLS_CD_TYP_T
/

CREATE TABLE END_CLS_CD_TYP_T
(
      CLS_CD_TYP VARCHAR(1)
        , CLS_CD_TYP_DESC VARCHAR(150)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_CLS_CD_TYP_TP1 PRIMARY KEY(CLS_CD_TYP)
...
# END_CMB_GRP_T
# -----------------------------------------------------------------------
drop table if exists END_CMB_GRP_T
/

CREATE TABLE END_CMB_GRP_T
(
      CMB_GRP_ID VARCHAR(5)
        , CMB_GRP_DESC VARCHAR(75) NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_CMB_GRP_TP1 PRIMARY KEY(CMB_GRP_ID)
...
# END_CRNT_CSH_T
# -----------------------------------------------------------------------
drop table if exists END_CRNT_CSH_T
/
...
(
    ...
    , CONSTRAINT END_CRNT_CSH_TP1 PRIMARY KEY(KEMID)
...
# -----------------------------------------------------------------------
drop table if exists END_CRNT_ENDOW_CORPUS_T
/

CREATE TABLE END_CRNT_ENDOW_CORPUS_T
(
      KEMID VARCHAR(10)
        , CRNT_CORPUS_VAL DECIMAL(19,2) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , CRNT_PRIN_MVAL DECIMAL(19,2)
    
    , CONSTRAINT END_CRNT_ENDOW_CORPUS_TP1 PRIMARY KEY(KEMID)
...
# -----------------------------------------------------------------------
drop table if exists END_CRNT_TAX_LOT_BAL_T
/
...
(
      KEMID VARCHAR(10)
        , SEC_ID VARCHAR(9)
        , REGIS_CD VARCHAR(4)
        , HLDG_LOT_NBR DECIMAL(4) default 1
        , HLDG_IP_IND VARCHAR(1)
        ...
        , HLDG_ACQD_DT DATETIME NOT NULL
        , HLDG_PRIOR_ACRD_INC DECIMAL(19,2) default 0 NOT NULL
        , HLDG_ACRD_INC_DUE DECIMAL(19,5) default 0 NOT NULL
        , LAST_TRAN_DT DATETIME NOT NULL
        , HLDG_MVAL DECIMAL(19,2) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_CRNT_TAX_LOT_BAL_TP1 PRIMARY KEY(KEMID,SEC_ID,REGIS_CD,HLDG_LOT_NBR,HLDG_IP_IND)
...
# END_CSH_SWEEP_MDL_T
# -----------------------------------------------------------------------
drop table if exists END_CSH_SWEEP_MDL_T
/

CREATE TABLE END_CSH_SWEEP_MDL_T
(
      CSH_SWEEP_MDL_ID DECIMAL(9)
        ...
        , CSH_SWEEP_MDL_DT DATETIME NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , PRIN_SWEEP_SEC_ID VARCHAR(9) NOT NULL
        , PRIN_SWEEP_REGIS_CD VARCHAR(4) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , CSH_SWEEP_NXT_DUE_DT DATETIME
    
    , CONSTRAINT END_CSH_SWEEP_MDL_TP1 PRIMARY KEY(CSH_SWEEP_MDL_ID)
...
# END_DONR_LBL_SEL_T
# -----------------------------------------------------------------------
drop table if exists END_DONR_LBL_SEL_T
/

CREATE TABLE END_DONR_LBL_SEL_T
(
      DONR_LBL_SEL VARCHAR(1)
        , DONR_LBL_SEL_DESC VARCHAR(50)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_DONR_LBL_SEL_TP1 PRIMARY KEY(DONR_LBL_SEL)
...
# END_DONR_STMT_CD_T
# -----------------------------------------------------------------------
drop table if exists END_DONR_STMT_CD_T
/

CREATE TABLE END_DONR_STMT_CD_T
(
      DONR_STMT_CD VARCHAR(5)
        , DONR_STMT_DESC VARCHAR(50) NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_DONR_STMT_CD_TP1 PRIMARY KEY(DONR_STMT_CD)
...
# END_DONR_T
# -----------------------------------------------------------------------
drop table if exists END_DONR_T
/
...
(
    ...
    , CONSTRAINT END_DONR_TP1 PRIMARY KEY(DONR_ID)
...
# -----------------------------------------------------------------------
drop table if exists END_ENDOW_ACCT_LINES_T
/
...
(
    ...
    , CONSTRAINT END_ENDOW_ACCT_LINES_TP1 PRIMARY KEY(FDOC_NBR,FDOC_LINE_NBR,FDOC_LN_TYP_CD)
...
# END_ENDOW_CORPUS_T
# -----------------------------------------------------------------------
drop table if exists END_ENDOW_CORPUS_T
/

CREATE TABLE END_ENDOW_CORPUS_T
(
      KEMID VARCHAR(10)
        , CORPUS_VAL_HIST_DT DATETIME
        , CORPUS_VAL DECIMAL(19,2) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_ENDOW_CORPUS_TP1 PRIMARY KEY(KEMID,CORPUS_VAL_HIST_DT)
...
# END_ETRAN_CD_T
# -----------------------------------------------------------------------
drop table if exists END_ETRAN_CD_T
/
...
(
      ETRAN_CD VARCHAR(9)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , CORPUS_IND VARCHAR(1) default 'N' NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
    
    , CONSTRAINT END_ETRAN_CD_TP1 PRIMARY KEY(ETRAN_CD)
...
# END_ETRAN_GL_LNK_T
# -----------------------------------------------------------------------
drop table if exists END_ETRAN_GL_LNK_T
/
...
(
    ...
    , CONSTRAINT END_ETRAN_GL_LNK_TP1 PRIMARY KEY(ETRAN_CD,CHART_CD)
...
# END_ETRAN_TYP_CD_T
# -----------------------------------------------------------------------
drop table if exists END_ETRAN_TYP_CD_T
/

CREATE TABLE END_ETRAN_TYP_CD_T
(
      ETRAN_TYP_CD VARCHAR(1)
        , ETRAN_TYP_DESC VARCHAR(40) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_ETRAN_TYP_CD_TP1 PRIMARY KEY(ETRAN_TYP_CD)
...
# -----------------------------------------------------------------------
drop table if exists END_FEE_BAL_TYP_CD_T
/

CREATE TABLE END_FEE_BAL_TYP_CD_T
(
      FEE_BAL_TYP_CD VARCHAR(3)
        , FEE_BAL_TYP_DESC VARCHAR(22) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_FEE_BAL_TYP_CD_TP1 PRIMARY KEY(FEE_BAL_TYP_CD)
...
# END_FEE_BASE_CD_T
# -----------------------------------------------------------------------
drop table if exists END_FEE_BASE_CD_T
/

CREATE TABLE END_FEE_BASE_CD_T
(
      FEE_BASE_CD VARCHAR(1)
        , FEE_BASE_DESC VARCHAR(9) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_FEE_BASE_CD_TP1 PRIMARY KEY(FEE_BASE_CD)
...
# END_FEE_CLS_CD_T
# -----------------------------------------------------------------------
drop table if exists END_FEE_CLS_CD_T
/
...
(
    ...
    , CONSTRAINT END_FEE_CLS_CD_TP1 PRIMARY KEY(FEE_MTHD,SEC_CLS_CD)
...
# END_FEE_ETRAN_CD_T
# -----------------------------------------------------------------------
drop table if exists END_FEE_ETRAN_CD_T
/
...
(
    ...
    , CONSTRAINT END_FEE_ETRAN_CD_TP1 PRIMARY KEY(FEE_MTHD,ETRAN_CD)
...
# END_FEE_MTHD_T
# -----------------------------------------------------------------------
drop table if exists END_FEE_MTHD_T
/
...
(
      FEE_MTHD VARCHAR(12)
        ...
        , FEE_NXT_PROC_DT DATETIME
        , FEE_LST_PROC_DT DATETIME
        ...
        , FEE_BY_TRAN_DOC_TYP VARCHAR(1) default 'N'
        , FEE_BY_ETRAN_CD VARCHAR(1) default 'N'
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , FEE_MIN_THRSHLD DECIMAL(4,2)
    
    , CONSTRAINT END_FEE_MTHD_TP1 PRIMARY KEY(FEE_MTHD)
...
# END_FEE_PMT_TYP_T
# -----------------------------------------------------------------------
drop table if exists END_FEE_PMT_TYP_T
/
...
(
    ...
    , CONSTRAINT END_FEE_PMT_TYP_TP1 PRIMARY KEY(FEE_MTHD)
...
# END_FEE_RT_DEF_CD_T
# -----------------------------------------------------------------------
drop table if exists END_FEE_RT_DEF_CD_T
/

CREATE TABLE END_FEE_RT_DEF_CD_T
(
      FEE_RT_DEF_CD VARCHAR(1)
        , FEE_RT_DEF_DESC VARCHAR(5) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_FEE_RT_DEF_CD_TP1 PRIMARY KEY(FEE_RT_DEF_CD)
...
# END_FEE_SEC_T
# -----------------------------------------------------------------------
drop table if exists END_FEE_SEC_T
/
...
(
    ...
    , CONSTRAINT END_FEE_SEC_TP1 PRIMARY KEY(FEE_MTHD,SEC_ID)
...
# -----------------------------------------------------------------------
drop table if exists END_FEE_TRAN_DOC_TYP_T
/
...
(
    ...
    , CONSTRAINT END_FEE_TRAN_DOC_TYP_TP1 PRIMARY KEY(FEE_MTHD,DOC_TYP_NM)
...
# END_FEE_TYP_CD_T
# -----------------------------------------------------------------------
drop table if exists END_FEE_TYP_CD_T
/

CREATE TABLE END_FEE_TYP_CD_T
(
      FEE_TYP_CD VARCHAR(1)
        , FEE_TYP_DESC VARCHAR(12) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_FEE_TYP_CD_TP1 PRIMARY KEY(FEE_TYP_CD)
...
# END_FND_SRC_CD_T
# -----------------------------------------------------------------------
drop table if exists END_FND_SRC_CD_T
/

CREATE TABLE END_FND_SRC_CD_T
(
      FND_SRC_CD VARCHAR(5)
        , FND_SRC_DESC VARCHAR(36) NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_FND_SRC_CD_TP1 PRIMARY KEY(FND_SRC_CD)
...
# END_FREQ_CD_T
# -----------------------------------------------------------------------
drop table if exists END_FREQ_CD_T
/
...
(
    ...
    , CONSTRAINT END_FREQ_CD_TP1 PRIMARY KEY(FREQ_CD)
...
# END_HIST_CSH_T
# -----------------------------------------------------------------------
drop table if exists END_HIST_CSH_T
/
...
(
    ...
    , CONSTRAINT END_HIST_CSH_TP1 PRIMARY KEY(KEMID,ME_DT_ID)
...
# -----------------------------------------------------------------------
drop table if exists END_HIST_VAL_ADJ_DOC_T
/
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , HLDG_ME_DT_ID DECIMAL(3) NOT NULL
        , SEC_UNIT_VAL DECIMAL(19,5) NOT NULL
        , SEC_MVAL DECIMAL(19,2)
        , TRAN_PSTD VARCHAR(1) default 'N' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_HIST_VAL_ADJ_DOC_TP1 PRIMARY KEY(FDOC_NBR)
...
# END_HLDG_HIST_T
# -----------------------------------------------------------------------
drop table if exists END_HLDG_HIST_T
/
...
(
    ...
    , CONSTRAINT END_HLDG_HIST_TP1 PRIMARY KEY(KEMID,ME_DT_ID,SEC_ID,REGIS_CD,HLDG_LOT_NBR,HLDG_IP_IND)
...
# -----------------------------------------------------------------------
drop table if exists END_HLDG_TAX_LOT_REBAL_T
/
...
(
      KEMID VARCHAR(10)
        ...
        , REGIS_CD VARCHAR(4)
        , HLDG_IP_IND VARCHAR(1)
        , TOT_HLDG_LOT_NBR DECIMAL(4) default 0 NOT NULL
        , TOT_HLDG_UNITS DECIMAL(16,4) default 0.0000 NOT NULL
        , TOT_HLDG_COST DECIMAL(19,2) default 0.00 NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_HLDG_TAX_LOT_REBAL_TP1 PRIMARY KEY(KEMID,SEC_ID,REGIS_CD,HLDG_IP_IND)
...
# END_HLDG_TAX_LOT_T
# -----------------------------------------------------------------------
drop table if exists END_HLDG_TAX_LOT_T
/
...
(
      KEMID VARCHAR(10)
        , SEC_ID VARCHAR(9)
        , REGIS_CD VARCHAR(4)
        , HLDG_LOT_NBR DECIMAL(4)
        , HLDG_IP_IND VARCHAR(1)
        , HLDG_UNITS DECIMAL(16,4) NOT NULL
        , HLDG_COST DECIMAL(19,2) NOT NULL
        , HLDG_ACQD_DT DATETIME NOT NULL
        , HLDG_PRIOR_ACRD_INC DECIMAL(19,2) default 0 NOT NULL
        , HLDG_ACRD_INC_DUE DECIMAL(19,5) default 0 NOT NULL
        , LAST_TRAN_DT DATETIME NOT NULL
    ...
    , CONSTRAINT END_HLDG_TAX_LOT_TP1 PRIMARY KEY(KEMID,SEC_ID,REGIS_CD,HLDG_LOT_NBR,HLDG_IP_IND)
...
# END_IP_IND_T
# -----------------------------------------------------------------------
drop table if exists END_IP_IND_T
/
...
(
    ...
    , CONSTRAINT END_IP_IND_TP1 PRIMARY KEY(IP_IND_CD)
...
# END_KEMID_AGRMNT_T
# -----------------------------------------------------------------------
drop table if exists END_KEMID_AGRMNT_T
/
...
(
      KEMID VARCHAR(10)
        ...
        , AGRMNT_STAT_DT DATETIME NOT NULL
    ...
    , CONSTRAINT END_KEMID_AGRMNT_TP1 PRIMARY KEY(KEMID,AGRMNT_ID)
...
# -----------------------------------------------------------------------
drop table if exists END_KEMID_BENE_ORG_T
/

CREATE TABLE END_KEMID_BENE_ORG_T
(
      KEMID VARCHAR(10)
        , BENE_ORG_SEQ DECIMAL(3)
        , BENE_ORG_CD VARCHAR(4)
        , BENE_PCT DECIMAL(3,2) NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , BENE_ORG_STRT_DT DATETIME NOT NULL
        , BENE_ORG_CHG_DT DATETIME
        , BENE_CHRT_CD VARCHAR(2)
    
    , CONSTRAINT END_KEMID_BENE_ORG_TP1 PRIMARY KEY(KEMID,BENE_ORG_SEQ,BENE_ORG_CD,BENE_CHRT_CD)
...
# END_KEMID_CMB_GRP_T
# -----------------------------------------------------------------------
drop table if exists END_KEMID_CMB_GRP_T
/
...
(
      KEMID VARCHAR(10)
        , CMB_SEQ DECIMAL(3)
        , CMB_GRP_ID VARCHAR(5)
        , CMB_DT DATETIME NOT NULL
        , TERM_CMB_DT DATETIME
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_KEMID_CMB_GRP_TP1 PRIMARY KEY(KEMID,CMB_SEQ,CMB_GRP_ID)
...
# -----------------------------------------------------------------------
drop table if exists END_KEMID_CORPUS_VAL_T
/

CREATE TABLE END_KEMID_CORPUS_VAL_T
(
      KEMID VARCHAR(10)
        , CRNT_CORPUS_VAL DECIMAL(19,2)
        , CRNT_PRIN_MVAL DECIMAL(19,2)
    ...
    , CONSTRAINT END_KEMID_CORPUS_VAL_TP1 PRIMARY KEY(KEMID)
...
# -----------------------------------------------------------------------
drop table if exists END_KEMID_DONR_CMB_T
/
...
(
    ...
    , CONSTRAINT END_KEMID_DONR_CMB_TP1 PRIMARY KEY(KEMID,CMB_SEQ)
...
# END_KEMID_DONR_T
# -----------------------------------------------------------------------
drop table if exists END_KEMID_DONR_T
/
...
(
    ...
    , CONSTRAINT END_KEMID_DONR_TP1 PRIMARY KEY(KEMID,DONR_ID,DONR_SEQ)
...
# END_KEMID_FEE_T
# -----------------------------------------------------------------------
drop table if exists END_KEMID_FEE_T
/
...
(
      KEMID VARCHAR(10)
        ...
        , FEE_IMPL_DT DATETIME NOT NULL
        , FEE_TERM_DT DATETIME
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_KEMID_FEE_TP1 PRIMARY KEY(KEMID,FEE_MTHD,FEE_MTHD_SEQ)
...
# END_KEMID_FND_SRC_T
# -----------------------------------------------------------------------
drop table if exists END_KEMID_FND_SRC_T
/

CREATE TABLE END_KEMID_FND_SRC_T
(
      KEMID VARCHAR(10)
        , KEMID_FND_SRC_SEQ DECIMAL(3)
        , FND_SRC_CD VARCHAR(5)
    ...
    , CONSTRAINT END_KEMID_FND_SRC_TP1 PRIMARY KEY(KEMID,KEMID_FND_SRC_SEQ,FND_SRC_CD)
...
# END_KEMID_GL_LNK_T
# -----------------------------------------------------------------------
drop table if exists END_KEMID_GL_LNK_T
/
...
(
    ...
    , CONSTRAINT END_KEMID_GL_LNK_TP1 PRIMARY KEY(KEMID,IP_IND_CD)
...
# END_KEMID_PAY_INC_T
# -----------------------------------------------------------------------
drop table if exists END_KEMID_PAY_INC_T
/

CREATE TABLE END_KEMID_PAY_INC_T
(
      KEMID VARCHAR(10)
        , PAY_INC_SEQ DECIMAL(3)
        , PAY_INC_TO_KEMID VARCHAR(10)
        , PAY_INC_PCT DECIMAL(3,2) NOT NULL
        , PAY_INC_STRT_DT DATETIME NOT NULL
        , PAY_INC_TERM_DT DATETIME
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_KEMID_PAY_INC_TP1 PRIMARY KEY(KEMID,PAY_INC_SEQ,PAY_INC_TO_KEMID)
...
# END_KEMID_ROLE_T
# -----------------------------------------------------------------------
drop table if exists END_KEMID_ROLE_T
/

CREATE TABLE END_KEMID_ROLE_T
(
      KEMID VARCHAR(10)
        , ROLE_SEQ_NBR VARCHAR(4)
        , ROLE_ID VARCHAR(40)
        , ROLE_PRNCPL_ID VARCHAR(40)
        , ROLE_TERM_DT DATETIME
        , ROW_ACTV_IND VARCHAR(1) default 'Y'
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_KEMID_ROLE_TP1 PRIMARY KEY(KEMID,ROLE_SEQ_NBR,ROLE_ID,ROLE_PRNCPL_ID)
...
# -----------------------------------------------------------------------
drop table if exists END_KEMID_SPCL_INSTRC_T
/

CREATE TABLE END_KEMID_SPCL_INSTRC_T
(
      KEMID VARCHAR(10)
        , INSTRC_SEQ DECIMAL(3)
        , AGRMNT_SPCL_INSTRC_CD VARCHAR(3)
        , CMNT VARCHAR(1024)
        , INSTRC_EST_DT DATETIME NOT NULL
        , INSTRC_TERM_DT DATETIME
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_KEMID_SPCL_INSTRC_TP1 PRIMARY KEY(KEMID,INSTRC_SEQ,AGRMNT_SPCL_INSTRC_CD)
...
# END_KEMID_T
# -----------------------------------------------------------------------
drop table if exists END_KEMID_T
/
...
# -----------------------------------------------------------------------
drop table if exists END_KEMID_USE_CRIT_T
/

CREATE TABLE END_KEMID_USE_CRIT_T
(
      KEMID VARCHAR(10)
        , USE_CRIT_SEQ DECIMAL(3)
        , USE_CRIT_CD VARCHAR(5)
        , USE_CRIT_ADTNL_DTA VARCHAR(150)
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_KEMID_USE_CRIT_TP1 PRIMARY KEY(KEMID,USE_CRIT_SEQ,USE_CRIT_CD)
...
# END_ME_DT_T
# -----------------------------------------------------------------------
drop table if exists END_ME_DT_T
/

CREATE TABLE END_ME_DT_T
(
      ME_DT_ID DECIMAL(3)
        , ME_DT DATETIME NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_ME_DT_TP1 PRIMARY KEY(ME_DT_ID)
...
# -----------------------------------------------------------------------
drop table if exists END_PENDING_TRAN_DOC_T
/
...
(
    ...
    , CONSTRAINT END_PENDING_TRAN_DOC_TP1 PRIMARY KEY(FDOC_NBR)
...
# END_PMT_TYP_CD_T
# -----------------------------------------------------------------------
drop table if exists END_PMT_TYP_CD_T
/
...
(
    ...
    , CONSTRAINT END_PMT_TYP_CD_TP1 PRIMARY KEY(PMT_TYP_CD)
...
# END_POOL_FND_CTRL_T
# -----------------------------------------------------------------------
drop table if exists END_POOL_FND_CTRL_T
/

CREATE TABLE END_POOL_FND_CTRL_T
(
      POOL_SEC_ID VARCHAR(9)
        , POOL_FND_DESC VARCHAR(120)
        , INCRM_VLTN_DAYS DECIMAL(3) default 0
        ...
        , DSTRB_GAIN_LOSS_IND VARCHAR(1) default 'N' NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , FRXNL_SHS_IND VARCHAR(1) default 'N' NOT NULL
        , POOL_REGIS_CD VARCHAR(4)
    
    , CONSTRAINT END_POOL_FND_CTRL_TP1 PRIMARY KEY(POOL_SEC_ID)
...
# END_POOL_FND_VAL_T
# -----------------------------------------------------------------------
drop table if exists END_POOL_FND_VAL_T
/
...
(
      POOL_SEC_ID VARCHAR(9)
        ...
        , ST_PROC_ON_DT DATETIME
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , POOL_FND_UNIT_VAL DECIMAL(19,5) default 1 NOT NULL
    
    , CONSTRAINT END_POOL_FND_VAL_TP1 PRIMARY KEY(POOL_SEC_ID,VAL_EFF_DT)
...
# END_PRPS_CD_T
# -----------------------------------------------------------------------
drop table if exists END_PRPS_CD_T
/
...
(
    ...
    , CONSTRAINT END_PRPS_CD_TP1 PRIMARY KEY(PRPS_CD)
...
# -----------------------------------------------------------------------
drop table if exists END_REC_CSH_XFR_GL_TGT_T
/

CREATE TABLE END_REC_CSH_XFR_GL_TGT_T
(
      XFR_NBR VARCHAR(14)
        , SRC_KEMID VARCHAR(10)
        , TGT_SEQ_NBR VARCHAR(14)
        , TGT_FIN_COA_CD VARCHAR(2) NOT NULL
        , TGT_ACCT_NBR VARCHAR(7) NOT NULL
        , TGT_SUB_ACCT_NBR VARCHAR(5)
        , TGT_FIN_OBJ_CD VARCHAR(4) NOT NULL
        , TGT_SUB_OBJ_CD VARCHAR(10)
        , TGT_PROJECT_CD VARCHAR(10)
        , TGT_FDOC_LN_AMT DECIMAL(19,2) default 0.00
        , TGT_PCT DECIMAL(3,2) default 0.00
        , TGT_USE_ETRAN_CD VARCHAR(9)
        , ROW_ACTV_IND VARCHAR(1) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , TGT_ORG_REF_ID VARCHAR(8)
    
    , CONSTRAINT END_REC_CSH_XFR_GL_TGT_TP1 PRIMARY KEY(XFR_NBR,SRC_KEMID,TGT_SEQ_NBR)
...
# -----------------------------------------------------------------------
drop table if exists END_REC_CSH_XFR_KEMID_TGT_T
/
...
(
      XFR_NBR VARCHAR(14)
        , SRC_KEMID VARCHAR(10)
        , TGT_SEQ_NBR VARCHAR(14)
        , TGT_KEMID VARCHAR(10) NOT NULL
        , TGT_ETRAN_CD VARCHAR(9) NOT NULL
        , TGT_LN_DESC VARCHAR(40)
        , TGT_IP_IND_CD VARCHAR(1) NOT NULL
        , TGT_AMT DECIMAL(19,2) default 0.00
        , TGT_PCT DECIMAL(3,2) default 0.00
        , TGT_USE_ETRAN_CD VARCHAR(9)
        , ROW_ACTV_IND VARCHAR(1) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    ...
    , CONSTRAINT END_REC_CSH_XFR_KEMID_TGT_TP1 PRIMARY KEY(XFR_NBR,SRC_KEMID,TGT_SEQ_NBR)
...
# END_REC_CSH_XFR_T
# -----------------------------------------------------------------------
drop table if exists END_REC_CSH_XFR_T
/
...
(
      XFR_NBR VARCHAR(14)
        , SRC_KEMID VARCHAR(10)
        , TRAN_DOC_TYP_CD VARCHAR(5) NOT NULL
        , SRC_ETRAN_CD VARCHAR(9) NOT NULL
        , SRC_LN_DESC VARCHAR(40)
        , SRC_IP_IND_CD VARCHAR(1) NOT NULL
        , FREQ_CD VARCHAR(4) NOT NULL
        , NXT_PROC_DT DATETIME NOT NULL
        , LST_PROC_DT DATETIME
        , ROW_ACTV_IND VARCHAR(1) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_REC_CSH_XFR_TP1 PRIMARY KEY(XFR_NBR,SRC_KEMID)
...
# END_REGIS_CD_T
# -----------------------------------------------------------------------
drop table if exists END_REGIS_CD_T
/
...
(
    ...
    , CONSTRAINT END_REGIS_CD_TP1 PRIMARY KEY(REGIS_CD)
...
# END_RESP_ADMIN_CD_T
# -----------------------------------------------------------------------
drop table if exists END_RESP_ADMIN_CD_T
/
...
(
    ...
    , CONSTRAINT END_RESP_ADMIN_CD_TP1 PRIMARY KEY(RESP_ADMIN_CD)
...
# END_SEC_RPT_GRP_T
# -----------------------------------------------------------------------
drop table if exists END_SEC_RPT_GRP_T
/

CREATE TABLE END_SEC_RPT_GRP_T
(
      SEC_RPT_GRP VARCHAR(5)
    ...
    , CONSTRAINT END_SEC_RPT_GRP_TP1 PRIMARY KEY(SEC_RPT_GRP)
...
# END_SEC_T
# -----------------------------------------------------------------------
drop table if exists END_SEC_T
/
...
(
      SEC_ID VARCHAR(9)
        ...
        , PREV_UNIT_VAL_DT DATETIME
        , SEC_CVAL DECIMAL(19,2) default 0
        , LAST_TRAN_DT DATETIME
        , SEC_INC_PAY_FREQ VARCHAR(4)
        , SEC_INC_NEXT_PAY_DT DATETIME
        , SEC_RT DECIMAL(19,5)
        , SEC_INC_CHG_DT DATETIME
        , SEC_ISS_DT DATETIME
        , SEC_DVDND_REC_DT DATETIME
        , SEC_EX_DVDND_DT DATETIME
        , SEC_DVDND_PAY_DT DATETIME
        ...
        , SEC_VAL_BY_MKT DECIMAL(19,2)
    
    , CONSTRAINT END_SEC_TP1 PRIMARY KEY(SEC_ID)
...
# END_SEC_VLTN_MTHD_T
# -----------------------------------------------------------------------
drop table if exists END_SEC_VLTN_MTHD_T
/
...
(
    ...
    , CONSTRAINT END_SEC_VLTN_MTHD_TP1 PRIMARY KEY(VLTN_MTHD)
...
# END_SUBCLS_CD_T
# -----------------------------------------------------------------------
drop table if exists END_SUBCLS_CD_T
/
...
(
    ...
    , CONSTRAINT END_SUBCLS_CD_TP1 PRIMARY KEY(SEC_SUBCLS_CD)
...
# END_TKLR_KEMID_T
# -----------------------------------------------------------------------
drop table if exists END_TKLR_KEMID_T
/

CREATE TABLE END_TKLR_KEMID_T
(
      TKLR_NBR VARCHAR(5)
        , TKLR_KEMID VARCHAR(10)
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TKLR_KEMID_TP1 PRIMARY KEY(TKLR_NBR,TKLR_KEMID)
...
# END_TKLR_RECP_GRP_T
# -----------------------------------------------------------------------
drop table if exists END_TKLR_RECP_GRP_T
/

CREATE TABLE END_TKLR_RECP_GRP_T
(
      TKLR_NBR VARCHAR(5)
        , TKLR_RECP_GRP_ID VARCHAR(40)
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TKLR_RECP_GRP_TP1 PRIMARY KEY(TKLR_NBR,TKLR_RECP_GRP_ID)
...
# -----------------------------------------------------------------------
drop table if exists END_TKLR_RECP_PRNCPL_T
/

CREATE TABLE END_TKLR_RECP_PRNCPL_T
(
      TKLR_NBR VARCHAR(5)
        , TKLR_RECP_PRNCPL_ID VARCHAR(40)
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TKLR_RECP_PRNCPL_TP1 PRIMARY KEY(TKLR_NBR,TKLR_RECP_PRNCPL_ID)
...
# END_TKLR_SEC_T
# -----------------------------------------------------------------------
drop table if exists END_TKLR_SEC_T
/

CREATE TABLE END_TKLR_SEC_T
(
      TKLR_NBR VARCHAR(5)
        , TKLR_SEC_ID VARCHAR(10)
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TKLR_SEC_TP1 PRIMARY KEY(TKLR_NBR,TKLR_SEC_ID)
...
# END_TKLR_T
# -----------------------------------------------------------------------
drop table if exists END_TKLR_T
/

CREATE TABLE END_TKLR_T
(
      TKLR_NBR VARCHAR(5)
        , TKLR_TYP_CD VARCHAR(4) NOT NULL
        , TKLR_FREQ VARCHAR(4)
        , TKLR_NXT_DUE_DT DATETIME NOT NULL
        , TKLR_DTL VARCHAR(1024) NOT NULL
        , TKLR_ENTRY_DT DATETIME NOT NULL
        , TKLR_TERM_DT DATETIME
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TKLR_TP1 PRIMARY KEY(TKLR_NBR)
...
# END_TKLR_TYP_CD_T
# -----------------------------------------------------------------------
drop table if exists END_TKLR_TYP_CD_T
/

CREATE TABLE END_TKLR_TYP_CD_T
(
      TKLR_TYP_CD VARCHAR(5)
        , TKLR_TYP_DESC VARCHAR(36) NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TKLR_TYP_CD_TP1 PRIMARY KEY(TKLR_TYP_CD)
...
# -----------------------------------------------------------------------
drop table if exists END_TRAN_ARCHV_SEC_T
/

CREATE TABLE END_TRAN_ARCHV_SEC_T
(
      FDOC_NBR VARCHAR(14)
        , FDOC_LN_NBR DECIMAL(7)
        , FDOC_LN_TYP_CD VARCHAR(1)
        , TRAN_SEC_ID VARCHAR(9) NOT NULL
        , TRAN_SEC_REGIS_CD VARCHAR(4)
        , TRAN_SEC_ETRAN_CD VARCHAR(9)
        , TRAN_SEC_UNITS DECIMAL(16,4)
        , TRAN_SEC_UNIT_VAL DECIMAL(19,5)
        , TRAN_SEC_COST DECIMAL(19,2)
        , TRAN_SEC_LT_GAIN_LOSS DECIMAL(19,2)
        , TRAN_SEC_ST_GAIN_LOSS DECIMAL(19,2)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_TRAN_ARCHV_SEC_TP1 PRIMARY KEY(FDOC_NBR,FDOC_LN_NBR,FDOC_LN_TYP_CD)
...
# END_TRAN_ARCHV_T
# -----------------------------------------------------------------------
drop table if exists END_TRAN_ARCHV_T
/
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , DOC_TYP_NM VARCHAR(64) NOT NULL
        , TRAN_SUB_TYP_CD VARCHAR(1) NOT NULL
        , TRAN_SRC_TYP_CD VARCHAR(1) NOT NULL
        , TRAN_KEMID VARCHAR(10) NOT NULL
        , TRAN_ETRAN_CD VARCHAR(9)
        , TRAN_LN_DESC VARCHAR(40)
        , TRAN_IP_IND_CD VARCHAR(1) NOT NULL
        , TRAN_INC_CSH_AMT DECIMAL(19,2)
        , TRAN_PRIN_CSH_AMT DECIMAL(19,2)
        , TRAN_CORPUS_IND VARCHAR(1) NOT NULL
        , TRAN_CORPUS_AMT DECIMAL(19,2)
        , TRAN_PSTD_DT DATETIME
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT END_TRAN_ARCHV_TP1 PRIMARY KEY(FDOC_NBR,FDOC_LN_NBR,FDOC_LN_TYP_CD)
...
# END_TRAN_DOC_T
# -----------------------------------------------------------------------
drop table if exists END_TRAN_DOC_T
/

CREATE TABLE END_TRAN_DOC_T
(
      FDOC_NBR VARCHAR(14)
        , TRAN_SUB_TYP_CD VARCHAR(1)
        , TRAN_SRC_TYP_CD VARCHAR(1) NOT NULL
        , TRAN_PSTD VARCHAR(1) default 'N' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , FDOC_NXT_SRC_LN_NBR DECIMAL(7)
        , FDOC_NXT_TAR_LN_NBR DECIMAL(7)
        , FDOC_NXT_SRC_ACCT_LN_NBR DECIMAL(7)
        , FDOC_NXT_TAR_ACCT_LN_NBR DECIMAL(7)
        , NO_ROUTE_IND VARCHAR(1) default 'N'
    
    , CONSTRAINT END_TRAN_DOC_TP1 PRIMARY KEY(FDOC_NBR)
...
# END_TRAN_HLDG_LOT_T
# -----------------------------------------------------------------------
drop table if exists END_TRAN_HLDG_LOT_T
/
...
(
      FDOC_NBR VARCHAR(14)
        , FDOC_LN_NBR DECIMAL(7)
        , FDOC_LN_TYP_CD VARCHAR(1)
        , TRAN_HLDG_LT_NBR DECIMAL(4)
        , LOT_UNITS DECIMAL(16,4) NOT NULL
        , LOT_HLDG_COST DECIMAL(19,2)
        , LOT_LT_GAIN_LOSS DECIMAL(19,2)
        , LOT_ST_GAIN_LOSS DECIMAL(19,2)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , LOT_ACQD_DT DATETIME
        , KEMID VARCHAR(10) NOT NULL
        , SEC_ID VARCHAR(9) NOT NULL
        , REGIS_CD VARCHAR(4) NOT NULL
        , HLDG_IP_IND VARCHAR(1) NOT NULL
        , NEW_LOT_IND VARCHAR(1) default 'N' NOT NULL
    
    , CONSTRAINT END_TRAN_HLDG_LOT_TP1 PRIMARY KEY(FDOC_NBR,FDOC_LN_NBR,FDOC_LN_TYP_CD,TRAN_HLDG_LT_NBR)
...
# END_TRAN_LN_T
# -----------------------------------------------------------------------
drop table if exists END_TRAN_LN_T
/
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , TRAN_LN_DESC VARCHAR(40)
        , TRAN_IP_IND_CD VARCHAR(1) NOT NULL
        , TRAN_AMT DECIMAL(19,2) NOT NULL
        , CORPUS_IND VARCHAR(1) default 'N' NOT NULL
        , TRAN_UNITS DECIMAL(16,4)
        , LN_PSTD VARCHAR(1) default 'N' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , UNIT_ADJ_AMT DECIMAL(19,5)
    
    , CONSTRAINT END_TRAN_LN_TP1 PRIMARY KEY(FDOC_NBR,FDOC_LN_TYP_CD,FDOC_LN_NBR)
...
# END_TRAN_RESTR_CD_T
# -----------------------------------------------------------------------
drop table if exists END_TRAN_RESTR_CD_T
/

CREATE TABLE END_TRAN_RESTR_CD_T
(
      TRAN_RESTR_CD VARCHAR(5)
        , TRAN_RESTR_DESC VARCHAR(36) NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TRAN_RESTR_CD_TP1 PRIMARY KEY(TRAN_RESTR_CD)
...
# END_TRAN_SEC_T
# -----------------------------------------------------------------------
drop table if exists END_TRAN_SEC_T
/

CREATE TABLE END_TRAN_SEC_T
(
      FDOC_NBR VARCHAR(14)
        , SEC_LN_TYP_CD VARCHAR(1)
        , SEC_ID VARCHAR(9) NOT NULL
        , SEC_REGIS_CD VARCHAR(4)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TRAN_SEC_TP1 PRIMARY KEY(FDOC_NBR,SEC_LN_TYP_CD)
...
# END_TRAN_SRC_TYP_T
# -----------------------------------------------------------------------
drop table if exists END_TRAN_SRC_TYP_T
/

CREATE TABLE END_TRAN_SRC_TYP_T
(
      TRAN_SRC_TYP_CD VARCHAR(1)
        , TRAN_SRC_TYP_DESC VARCHAR(40)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TRAN_SRC_TYP_TP1 PRIMARY KEY(TRAN_SRC_TYP_CD)
...
# END_TRAN_SUB_TYP_T
# -----------------------------------------------------------------------
drop table if exists END_TRAN_SUB_TYP_T
/

CREATE TABLE END_TRAN_SUB_TYP_T
(
      TRAN_SUB_TYP_CD VARCHAR(1)
        , TRAN_SUB_TYP_DESC VARCHAR(40)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TRAN_SUB_TYP_TP1 PRIMARY KEY(TRAN_SUB_TYP_CD)
...
# END_TYP_FEE_MTHD_T
# -----------------------------------------------------------------------
drop table if exists END_TYP_FEE_MTHD_T
/
...
(
      TYP_CD VARCHAR(3)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , ROW_ACTV_IND VARCHAR(1) default 'N' NOT NULL
    
    , CONSTRAINT END_TYP_FEE_MTHD_TP1 PRIMARY KEY(TYP_CD,FEE_MTHD)
...
# END_TYP_RESTR_CD_T
# -----------------------------------------------------------------------
drop table if exists END_TYP_RESTR_CD_T
/

CREATE TABLE END_TYP_RESTR_CD_T
(
      TYP_RESTR_CD VARCHAR(3)
    ...
    , CONSTRAINT END_TYP_RESTR_CD_TP1 PRIMARY KEY(TYP_RESTR_CD)
...
# END_TYP_T
# -----------------------------------------------------------------------
drop table if exists END_TYP_T
/
...
(
      TYP_CD VARCHAR(3)
        ...
        , TYP_CSH_SWEEP_MDL_ID DECIMAL(9)
        , TYP_INC_ACI_MDL_ID DECIMAL(9)
        , TYP_PRIN_ACI_MDL_ID DECIMAL(9)
        , ROW_ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
    
    , CONSTRAINT END_TYP_TP1 PRIMARY KEY(TYP_CD)
...
# END_USE_CRIT_T
# -----------------------------------------------------------------------
drop table if exists END_USE_CRIT_T
/
...
(
    ...
    , CONSTRAINT END_USE_CRIT_TP1 PRIMARY KEY(USE_CRIT_CD)
...
(
    ...
    , CONSTRAINT FP_CPTL_AST_INFO_DTL_TP1 PRIMARY KEY(FDOC_NBR,ITM_LN_NBR,CPTLAST_LINE_NBR)
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , CPTLAST_ACTION_IND VARCHAR(1) default 'C'
        , CPTLAST_PROCESSED_IND VARCHAR(1) default 'N'
        , CPTLAST_DST_AMT_CD VARCHAR(1) default '1'
    
    , CONSTRAINT FP_CPTL_AST_INFO_TP1 PRIMARY KEY(FDOC_NBR,CPTLAST_LINE_NBR)
...
(
    ...
    , INDEX FP_PRCRMNT_ACCT_LINES_TI2 (FIN_COA_CD, ACCOUNT_NBR)
    , INDEX FP_PRCRMNT_ACCT_LINES_TI3 (FDOC_POST_YR, FIN_COA_CD, FIN_OBJECT_CD)
...
(
    ...
    , INDEX GL_ACCT_BALANCES_TI2 (UNIV_FISCAL_YR, FIN_COA_CD, FIN_OBJECT_CD)
    , INDEX GL_ACCT_BALANCES_TI3 (TIMESTAMP)
...
(
    ...
    , INDEX GL_BALANCE_TI2 (TIMESTAMP)
...
(
    ...
    , INDEX GL_ENCUMBRANCE_TI2 (TIMESTAMP)
...
(
    ...
    , INDEX GL_ENTRY_TI2 (FDOC_NBR, FS_ORIGIN_CD)
    , INDEX GL_ENTRY_TI3 (TIMESTAMP)
...
# LD_A21_DETAIL_LN_T
# -----------------------------------------------------------------------
drop table if exists LD_A21_DETAIL_LN_T
/
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , FIN_OBJECT_CD VARCHAR(4)
        , SOURCE_FIN_COA_CD VARCHAR(2)
        , SOURCE_ACCT_NBR VARCHAR(7)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , A21_LBR_PYRL_AMT DECIMAL(19,2)
        , LBR_CALC_OVRLL_PCT DECIMAL(3)
        , LBR_UPDT_OVRLL_PCT DECIMAL(3)
        , FDOC_POST_YR DECIMAL(4)
        , CST_SRCSUBACCT_NBR VARCHAR(5)
        , A21_LBRORIG_PY_AMT DECIMAL(19,2)
    
    , CONSTRAINT LD_A21_DETAIL_LN_TP1 PRIMARY KEY(FDOC_NBR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,POSITION_NBR,FIN_OBJECT_CD,SOURCE_FIN_COA_CD,SOURCE_ACCT_NBR)

    , CONSTRAINT LD_A21_DETAIL_LN_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_A21_DETAIL_LN_TI2 (FIN_COA_CD, ACCOUNT_NBR)
...
# LD_A21_DETAIL_T
# -----------------------------------------------------------------------
drop table if exists LD_A21_DETAIL_T
/
...
(
      FDOC_NBR VARCHAR(14)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , A21_LBR_RPT_NBR VARCHAR(3)
        , A21_LBR_DOC_CD VARCHAR(2) NOT NULL
        , A21_LBR_FSCL_YR DECIMAL(4)
        , EMPLID VARCHAR(40)
    
    , CONSTRAINT LD_A21_DETAIL_TP1 PRIMARY KEY(FDOC_NBR)

    , CONSTRAINT LD_A21_DETAIL_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_A21_DETAIL_TI2 (EMPLID)
    , INDEX LD_A21_DETAIL_TI4 (A21_LBR_RPT_NBR, A21_LBR_FSCL_YR)
...
# LD_A21_DTL_BLD_T
# -----------------------------------------------------------------------
drop table if exists LD_A21_DTL_BLD_T
/

CREATE TABLE LD_A21_DTL_BLD_T
(
      A21_LBR_BLD_NBR DECIMAL(19)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , A21_LBR_RPT_NBR VARCHAR(3)
        , A21_LBR_DOC_CD VARCHAR(2)
        , A21_LBR_FSCL_YR DECIMAL(4)
        , EMPLID VARCHAR(40)
    
    , CONSTRAINT LD_A21_DTL_BLD_TP1 PRIMARY KEY(A21_LBR_BLD_NBR)

    , CONSTRAINT LD_A21_DTL_BLD_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_A21_DTL_BLD_TI2 (EMPLID)
    , INDEX LD_A21_DTL_BLD_TI4 (A21_LBR_RPT_NBR, A21_LBR_FSCL_YR)
...
# LD_A21_DTL_LN_BLD_T
# -----------------------------------------------------------------------
drop table if exists LD_A21_DTL_LN_BLD_T
/
...
(
    ...
    , CONSTRAINT LD_A21_DTL_LN_BLD_TP1 PRIMARY KEY(A21_LBR_BLD_NBR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,POSITION_NBR,FIN_OBJECT_CD,SOURCE_FIN_COA_CD,SOURCE_ACCT_NBR)

    , CONSTRAINT LD_A21_DTL_LN_BLD_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_A21_DTL_LN_BLD_TI2 (FIN_COA_CD, ACCOUNT_NBR)
...
# LD_A21_PRD_STAT_T
# -----------------------------------------------------------------------
drop table if exists LD_A21_PRD_STAT_T
/

CREATE TABLE LD_A21_PRD_STAT_T
(
      LBR_RPT_PRDSTAT_CD VARCHAR(1)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , LBR_PRD_STAT_DESC VARCHAR(40)
    
    , CONSTRAINT LD_A21_PRD_STAT_TP1 PRIMARY KEY(LBR_RPT_PRDSTAT_CD)
...
# LD_A21_REPORT_T
# -----------------------------------------------------------------------
drop table if exists LD_A21_REPORT_T
/
...
(
      A21_LBR_RPT_NBR VARCHAR(3)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , A21LBR_RPT_PRD_TTL VARCHAR(30)
        , LBR_RPT_PRDSTAT_CD VARCHAR(1)
        , LBR_ET_FSCL_YR DECIMAL(4)
        , LBR_ET_FSCL_PRD_CD VARCHAR(2)
        , A21_LBR_RPT_TYP_CD VARCHAR(2)
        , A21LBR_RPT_RTRN_DT DATETIME
        , LBR_RPT_BEG_FSCL_YR DECIMAL(4)
        , LBR_RPT_BEG_FSCL_PRD_CD VARCHAR(2)
        , LBR_RPT_END_FSCL_YR DECIMAL(4)
        , LBR_RPT_END_FSCL_PRD_CD VARCHAR(2)
        , ROW_ACTV_IND VARCHAR(1) NOT NULL
    
    , CONSTRAINT LD_A21_REPORT_TP1 PRIMARY KEY(A21_LBR_RPT_NBR,UNIV_FISCAL_YR)
...
# -----------------------------------------------------------------------
drop table if exists LD_A21_RPT_EARN_PAY_T
/
...
(
    ...
    , CONSTRAINT LD_A21_RPT_EARN_PAY_TP1 PRIMARY KEY(UNIV_FISCAL_YR,A21_LBR_RPT_TYP_CD,ERNCD,PAYGROUP)
...
# LD_A21_RPT_POS_T
# -----------------------------------------------------------------------
drop table if exists LD_A21_RPT_POS_T
/
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        , A21_LBR_RPT_NBR VARCHAR(3)
        , LBR_RPT_POSOBJ_CD VARCHAR(2)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , ROW_ACTV_IND VARCHAR(1) NOT NULL
    
    , CONSTRAINT LD_A21_RPT_POS_TP1 PRIMARY KEY(UNIV_FISCAL_YR,A21_LBR_RPT_NBR,LBR_RPT_POSOBJ_CD)
...
# LD_A21_RPT_TYP_T
# -----------------------------------------------------------------------
drop table if exists LD_A21_RPT_TYP_T
/
...
(
      A21_LBR_RPT_TYP_CD VARCHAR(2)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , A21_LBR_RPT_DESC VARCHAR(40)
        , ROW_ACTV_IND VARCHAR(1) NOT NULL
    
    , CONSTRAINT LD_A21_RPT_TYP_TP1 PRIMARY KEY(A21_LBR_RPT_TYP_CD)
...
# LD_BCNSTR_HDR_T
# -----------------------------------------------------------------------
drop table if exists LD_BCNSTR_HDR_T
/
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , ORG_LEVEL_CD DECIMAL(7)
        , ORG_COA_OF_LVL_CD VARCHAR(2)
        , ORG_OF_LVL_CD VARCHAR(4)
        , BDGT_LOCK_USR_ID VARCHAR(40)
        , BDGT_TRNLCK_USR_ID VARCHAR(40)
    
    , CONSTRAINT LD_BCNSTR_HDR_TP1 PRIMARY KEY(FDOC_NBR,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR)

    , CONSTRAINT LD_BCNSTR_HDR_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_BCNSTR_HDR_TI2 (FIN_COA_CD, ACCOUNT_NBR)
    , INDEX LD_BCNSTR_HDR_TI4 (BDGT_LOCK_USR_ID)
...
# LD_BCNSTR_MONTH_T
# -----------------------------------------------------------------------
drop table if exists LD_BCNSTR_MONTH_T
/
...
(
    ...
    , CONSTRAINT LD_BCNSTR_MONTH_TP1 PRIMARY KEY(FDOC_NBR,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,FIN_BALANCE_TYP_CD,FIN_OBJ_TYP_CD)


    , INDEX LD_BCNSTR_MONTH_TI2 (UNIV_FISCAL_YR, FIN_COA_CD, FIN_OBJECT_CD)
    , INDEX LD_BCNSTR_MONTH_TI3 (UNIV_FISCAL_YR, FIN_COA_CD, ACCOUNT_NBR, SUB_ACCT_NBR, FIN_OBJECT_CD, FIN_SUB_OBJ_CD, FIN_BALANCE_TYP_CD, FIN_OBJ_TYP_CD)
...
# LD_BCN_2PLG_LIST_MT
# -----------------------------------------------------------------------
drop table if exists LD_BCN_2PLG_LIST_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_2PLG_LIST_MTP1 PRIMARY KEY(PERSON_UNVL_ID,ORG_FIN_COA_CD,ORG_CD,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR)
...
# LD_BCN_ACCTSEL_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_ACCTSEL_T
/
...
(
      PERSON_UNVL_ID VARCHAR(40)
        ...
        , FDOC_STATUS_CD VARCHAR(2)
        , FDOC_INITIATOR_ID VARCHAR(40)
        , FDOC_CREATE_DT DATETIME
    
    , CONSTRAINT LD_BCN_ACCTSEL_TP1 PRIMARY KEY(PERSON_UNVL_ID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FDOC_NBR)


    , INDEX LD_BCN_ACCTSEL_TI2 (FDOC_NBR, UNIV_FISCAL_YR, FIN_COA_CD, ACCOUNT_NBR, SUB_ACCT_NBR)
...
# LD_BCN_ACCT_BAL_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_ACCT_BAL_T
/
...
(
      PERSON_UNVL_ID VARCHAR(40)
        ...
        , ACCOUNT_NBR VARCHAR(7)
        , SUB_ACCT_NBR VARCHAR(5)
        , INC_EXP_CD VARCHAR(1)
        , FIN_LEVEL_SORT_CD VARCHAR(2)
        , FIN_OBJECT_CD VARCHAR(4)
        , FIN_SUB_OBJ_CD VARCHAR(3)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , FIN_CONS_SORT_CD VARCHAR(2)
        , FIN_OBJ_LEVEL_CD VARCHAR(4)
        , APPT_RQST_FTE_QTY DECIMAL(22,6)
        , APPT_RQCSF_FTE_QTY DECIMAL(22,6)
        , POSITION_FTE_QTY DECIMAL(22,6)
        , FIN_BEG_BAL_LN_AMT DECIMAL(19,2)
        , ACLN_ANNL_BAL_AMT DECIMAL(19,2)
        , POS_CSF_LV_FTE_QTY DECIMAL(22,6)
    
    , CONSTRAINT LD_BCN_ACCT_BAL_TP1 PRIMARY KEY(PERSON_UNVL_ID,ORG_FIN_COA_CD,ORG_CD,SUB_FUND_GRP_CD,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,INC_EXP_CD,FIN_LEVEL_SORT_CD,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)
...
# LD_BCN_ACCT_DUMP_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_ACCT_DUMP_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_ACCT_DUMP_TP1 PRIMARY KEY(PERSON_UNVL_ID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_ACCT_ORG_HIER_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_ACCT_ORG_HIER_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,ORG_LEVEL_CD)
...
# LD_BCN_ACCT_RPTS_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_ACCT_RPTS_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_ACCT_RPTS_TP1 PRIMARY KEY(FIN_COA_CD,ACCOUNT_NBR)

    , CONSTRAINT LD_BCN_ACCT_RPTS_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_BCN_ACCT_RPTS_TI2 (RPTS_TO_ORG_CD, RPTS_TO_FIN_COA_CD)
...
# LD_BCN_ACCT_SUMM_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_ACCT_SUMM_T
/
...
(
      PERSON_UNVL_ID VARCHAR(40)
        ...
        , ACLN_ANNL_BAL_AMT DECIMAL(19,2)
        , FIN_BEG_BAL_LN_AMT DECIMAL(19,2)
        , SUB_FUND_SORT_CD VARCHAR(2)
    
    , CONSTRAINT LD_BCN_ACCT_SUMM_TP1 PRIMARY KEY(PERSON_UNVL_ID,ORG_FIN_COA_CD,ORG_CD,FIN_COA_CD,FUND_GRP_CD,SUB_FUND_GRP_CD,ACCOUNT_NBR,SUB_ACCT_NBR,INC_EXP_CD)
...
# LD_BCN_ACTV_JOB_MT
# -----------------------------------------------------------------------
drop table if exists LD_BCN_ACTV_JOB_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_ACTV_JOB_MTP1 PRIMARY KEY(PERSON_UNVL_ID,EMPLID,EMPL_RCD,EFFDT,EFFSEQ)
...
# LD_BCN_ADM_POST_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_ADM_POST_T
/
...
(
      EMPLID VARCHAR(40)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , ADMIN_POST VARCHAR(15)
    
    , CONSTRAINT LD_BCN_ADM_POST_TP1 PRIMARY KEY(EMPLID,POSITION_NBR)
...
# LD_BCN_AF_LOAD01_MT
# -----------------------------------------------------------------------
drop table if exists LD_BCN_AF_LOAD01_MT
/
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        ...
        , EMPLID VARCHAR(40)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , APPT_FND_DUR_CD VARCHAR(4)
        , APPT_RQST_CSF_AMT DECIMAL(19,2)
        , APPT_RQCSF_FTE_QTY DECIMAL(22,6)
        , APPT_RQCSF_TM_PCT DECIMAL(22,6)
        , APPT_TOT_INTND_AMT DECIMAL(19,2)
        , APPT_TOTINTFTE_QTY DECIMAL(22,6)
        , APPT_RQST_AMT DECIMAL(19,2)
        , APPT_RQST_TM_PCT DECIMAL(22,6)
        , APPT_RQST_FTE_QTY DECIMAL(22,6)
        , APPT_RQST_PAY_RT DECIMAL(8,2)
        , APPT_FND_DLT_CD VARCHAR(1)
        , APPT_FND_MO DECIMAL(2)
        , NEW_FIN_COA_CD VARCHAR(2)
        , NEW_ACCOUNT_NBR VARCHAR(7)
    
    , CONSTRAINT LD_BCN_AF_LOAD01_MTP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,POSITION_NBR,EMPLID)
...
# LD_BCN_AF_LOAD02_MT
# -----------------------------------------------------------------------
drop table if exists LD_BCN_AF_LOAD02_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_AF_LOAD02_MTP1 PRIMARY KEY(FIN_COA_CD,ACCOUNT_NBR)


    , INDEX LD_BCN_AF_LOAD02_MTI2 (ACCOUNT_NBR, FIN_COA_CD)
...
# LD_BCN_AF_LOAD_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_AF_LOAD_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_AF_LOAD_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,POSITION_NBR,EMPLID)
...
# LD_BCN_AF_REASON_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_AF_REASON_T
/
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        ...
        , POSITION_NBR VARCHAR(8)
        , EMPLID VARCHAR(40)
        , APPT_FND_REASON_CD VARCHAR(3)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , APPT_FND_REASN_AMT DECIMAL(19,2)
    
    , CONSTRAINT LD_BCN_AF_REASON_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,POSITION_NBR,EMPLID,APPT_FND_REASON_CD)

    , CONSTRAINT LD_BCN_AF_REASON_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_BCN_AF_REASON_TI2 (APPT_FND_REASON_CD)
...
# LD_BCN_AF_RSN_CD_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_AF_RSN_CD_T
/
...
(
      APPT_FND_REASON_CD VARCHAR(3)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , APPT_FND_RESN_DESC VARCHAR(40)
        , ROW_ACTV_IND VARCHAR(1) NOT NULL
    
    , CONSTRAINT LD_BCN_AF_RSN_CD_TP1 PRIMARY KEY(APPT_FND_REASON_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BAL_BY_ACCT_T
/
...
(
      PERSON_UNVL_ID VARCHAR(40)
        ...
        , TYP_FIN_REPORT_SORT_CD VARCHAR(2)
        , FIN_CONS_SORT_CD VARCHAR(2)
        , LEV_FIN_REPORT_SORT_CD VARCHAR(2)
        , APPT_RQST_FTE_QTY DECIMAL(22,6)
        , APPT_RQCSF_FTE_QTY DECIMAL(22,6)
        , POS_CSF_FTE_QTY DECIMAL(22,6)
        , ACLN_ANNL_BAL_AMT DECIMAL(19,2)
        , FIN_BEG_BAL_LN_AMT DECIMAL(19,2)
        , POS_CSF_LV_FTE_QTY DECIMAL(22,6)
    
    , CONSTRAINT LD_BCN_BAL_BY_ACCT_TP1 PRIMARY KEY(PERSON_UNVL_ID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)


    , INDEX LD_BCN_BAL_BY_ACCT_TI2 (UNIV_FISCAL_YR, FIN_COA_CD, FIN_OBJECT_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BENEFITS_RECALC01_MT
/

CREATE TABLE LD_BCN_BENEFITS_RECALC01_MT
(
      SESID VARCHAR(36)
        , POS_FRNGBEN_OBJ_CD VARCHAR(4)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , FB_SUM DECIMAL(19,2)
    
    , CONSTRAINT LD_BCN_BENEFITS_RECALC01_MTP1 PRIMARY KEY(SESID,POS_FRNGBEN_OBJ_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_ACCTBAL01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_ACCTBAL01_MTP1 PRIMARY KEY(SESID,ORG_FIN_COA_CD,ORG_CD,SUB_FUND_GRP_CD,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,INC_EXP_CD,FIN_CONS_SORT_CD,FIN_LEVEL_SORT_CD,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_CTRL_LIST01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_CTRL_LIST01_MTP1 PRIMARY KEY(SESID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,ORG_LEVEL_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_CTRL_LIST02_MT
/
...
(
      SESID VARCHAR(36)
        ...
        , SUB_ACCT_NBR VARCHAR(5)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , HIER_ORG_LVL_CD DECIMAL(7)
        , SEL_ORG_LVL_CD DECIMAL(7)
        , SEL_ORG_FIN_COA VARCHAR(2)
        , SEL_ORG_CD VARCHAR(4)
        , SEL_PULL_FLAG DECIMAL(7)
    
    , CONSTRAINT LD_BCN_BUILD_CTRL_LIST02_MTP1 PRIMARY KEY(SESID,PERSON_UNVL_ID,FDOC_NBR,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_EXSALTOT01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_EXSALTOT01_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_EXSALTOT02_MT
/
...
(
      SESID VARCHAR(36) NOT NULL
        ...
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , SAL_AMT DECIMAL(19,2)
        , SAL_PCT DECIMAL(22,6)
        , SAL_MTHS DECIMAL(2)
        , POS_CSF_AMT DECIMAL(19,2)
        , POS_CSF_TM_PCT DECIMAL(22,6)
        , SAL_PMTHS DECIMAL(2)
    


    , INDEX LD_BCN_BUILD_EXSALTOT02_MTI2 (SESID, EMPLID, POSITION_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_EXSALTOT03_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_EXSALTOT03_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_EXSALTOT04_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_EXSALTOT04_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_EXSALTOT05_MT
/
...
(
      SESID VARCHAR(36)
        ...
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , POS_CSF_AMT DECIMAL(19,2)
        , RES_CSF_AMT DECIMAL(19,2)
        , POS_CSF_TM_PCT DECIMAL(22,6)
        , SAL_AMT DECIMAL(19,2)
        , SAL_PCT DECIMAL(22,6)
        , SAL_FTE DECIMAL(22,6)
        , SAL_MTHS DECIMAL(2)
        , SAL_PMTHS DECIMAL(2)
        , CSF_MTHS DECIMAL(2)
        , CSF_PMTHS DECIMAL(2)
    ...
    , CONSTRAINT LD_BCN_BUILD_EXSALTOT05_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_EXSALTOT06_MT
/
...
(
      SESID VARCHAR(36)
        ...
        , APPT_RQST_AMT DECIMAL(19,2)
        , APPT_RQST_FTE_QTY DECIMAL(22,6)
        , INIT_RQST_AMT DECIMAL(19,2)
        , INIT_RQST_FTE DECIMAL(22,6)
    
    , CONSTRAINT LD_BCN_BUILD_EXSALTOT06_MTP1 PRIMARY KEY(SESID,ORG_FIN_COA_CD,ORG_CD,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_LEVLSUMM02_MT
/

CREATE TABLE LD_BCN_BUILD_LEVLSUMM02_MT
(
      SESID VARCHAR(36) NOT NULL
        , ORG_FIN_COA_CD VARCHAR(2) NOT NULL
        , ORG_CD VARCHAR(4) NOT NULL
        , SUB_FUND_GRP_CD VARCHAR(6) NOT NULL
        , FIN_COA_CD VARCHAR(2) NOT NULL
        , INC_EXP_CD VARCHAR(1) NOT NULL
        , FIN_CONS_OBJ_CD VARCHAR(4) NOT NULL
        , FIN_OBJ_LEVEL_CD VARCHAR(4) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , POS_CSF_FNDSTAT_CD VARCHAR(1)
        , POS_CSF_FTE_QTY DECIMAL(22,6)
        , POS_CSF_LV_FTE_QTY DECIMAL(22,6)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_LEVLSUMM03_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_LEVLSUMM03_MTP1 PRIMARY KEY(SESID,ORG_FIN_COA_CD,ORG_CD,SUB_FUND_GRP_CD,FIN_COA_CD,INC_EXP_CD,FIN_CONS_OBJ_CD,FIN_OBJ_LEVEL_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_MNTHSUMM01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_MNTHSUMM01_MTP1 PRIMARY KEY(SESID,SEL_ORG_FIN_COA,SEL_ORG_CD,SEL_SUB_FUND_GRP,UNIV_FISCAL_YR,FIN_COA_CD,INC_EXP_CD,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_MNTHSUMM02_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_MNTHSUMM02_MTP1 PRIMARY KEY(SESID,SEL_ORG_FIN_COA,SEL_ORG_CD,SEL_SUB_FUND_GRP,UNIV_FISCAL_YR,FIN_COA_CD,INC_EXP_CD,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_OBJTSUMM01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_OBJTSUMM01_MTP1 PRIMARY KEY(SESID,ORG_FIN_COA_CD,ORG_CD,SUB_FUND_GRP_CD,FIN_COA_CD,INC_EXP_CD,FIN_CONS_OBJ_CD,FIN_OBJ_LEVEL_CD,FIN_OBJECT_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_OBJTSUMM02_MT
/
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_POSLIST01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_POSLIST01_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_POS_SEL01_MT
/
...
(
      SESID VARCHAR(36)
        ...
        , ORG_CD VARCHAR(4)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , ORG_LEVEL_CD DECIMAL(7) NOT NULL
    
    , CONSTRAINT LD_BCN_BUILD_POS_SEL01_MTP1 PRIMARY KEY(SESID,FIN_COA_CD,ORG_CD)


    , INDEX LD_BCN_BUILD_POS_SEL01_MTI2 (ORG_CD, FIN_COA_CD, SESID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_PULLUP01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_PULLUP01_MTP1 PRIMARY KEY(SESID,FIN_COA_CD,ORG_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALSUMM01_MT
/
...
(
    ...
    , INDEX LD_BCN_BUILD_SALSUMM01_MTI2 (SESID, EMPLID, POSITION_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALSUMM02_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_SALSUMM02_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALSUMM03_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_SALSUMM03_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALSUMM04_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_SALSUMM04_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALSUMM05_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_SALSUMM05_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALTOT01_MT
/
...
(
    ...
    , INDEX LD_BCN_BUILD_SALTOT01_MTI2 (SESID, EMPLID, POSITION_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALTOT02_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_SALTOT02_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALTOT03_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_SALTOT03_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALTOT04_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_SALTOT04_MTP1 PRIMARY KEY(SESID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_BUILD_SALTOT05_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_BUILD_SALTOT05_MTP1 PRIMARY KEY(SESID,ORG_FIN_COA_CD,ORG_CD,EMPLID)
...
# LD_BCN_CSF_TRCKR_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_CSF_TRCKR_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_CSF_TRCKR_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,POSITION_NBR,EMPLID)
...
# LD_BCN_CTRL_LIST_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_CTRL_LIST_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_CTRL_LIST_TP1 PRIMARY KEY(PERSON_UNVL_ID,FDOC_NBR,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_DOC_PULLUP01_MT
/
...
(
      SESID VARCHAR(36)
        ...
        , ACCOUNT_NBR VARCHAR(7)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , SORG_FIN_COA_CD VARCHAR(2)
        , SORG_CD VARCHAR(4)
        , PULL_FLAG DECIMAL(5)
    
    , CONSTRAINT LD_BCN_DOC_PULLUP01_MTP1 PRIMARY KEY(SESID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_DOC_PULLUP02_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_DOC_PULLUP02_MTP1 PRIMARY KEY(SESID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_DOC_PULLUP03_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_DOC_PULLUP03_MTP1 PRIMARY KEY(SESID,FDOC_NBR)


    , INDEX LD_BCN_DOC_PULLUP03_MTI2 (FDOC_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_DOC_PUSHDOWN01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_DOC_PUSHDOWN01_MTP1 PRIMARY KEY(SESID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_DOC_PUSHDOWN02_MT
/
...
(
      SESID VARCHAR(36)
        ...
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , ORG_LEVEL_CD DECIMAL(7) NOT NULL
        , SEL_ORG_LVL DECIMAL(7) NOT NULL
        , SEL_ORGFIN_COA VARCHAR(2)
        , SEL_ORG VARCHAR(4)
        , SEL_PULLFLAG DECIMAL(5)
    
    , CONSTRAINT LD_BCN_DOC_PUSHDOWN02_MTP1 PRIMARY KEY(SESID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_DOC_PUSHDOWN03_MT
/
...
(
      SESID VARCHAR(36)
        ...
        , SEL_ORG VARCHAR(4)
        , SEL_PULLFLAG DECIMAL(5)
        , LONE_ORGFIN_COA VARCHAR(2)
        , LONE_ORG VARCHAR(4)
    
    , CONSTRAINT LD_BCN_DOC_PUSHDOWN03_MTP1 PRIMARY KEY(SESID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_DOC_PUSHDOWN04_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_DOC_PUSHDOWN04_MTP1 PRIMARY KEY(SESID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR)
...
# LD_BCN_DURATION_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_DURATION_T
/

CREATE TABLE LD_BCN_DURATION_T
(
      APPT_DUR_CD VARCHAR(4)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , APPT_DUR_DESC VARCHAR(40)
        , ROW_ACTV_IND VARCHAR(1) NOT NULL
    
    , CONSTRAINT LD_BCN_DURATION_TP1 PRIMARY KEY(APPT_DUR_CD)
...
# LD_BCN_FND_LOCK_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_FND_LOCK_T
/

CREATE TABLE LD_BCN_FND_LOCK_T
(
      APPT_FNDLCK_USR_ID VARCHAR(40)
        , ACCOUNT_NBR VARCHAR(7)
        , SUB_ACCT_NBR VARCHAR(5)
        , FIN_COA_CD VARCHAR(2)
        , UNIV_FISCAL_YR DECIMAL(4)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , FILL2 VARCHAR(255) NOT NULL
        , FILL3 VARCHAR(255) NOT NULL
        , FILL4 VARCHAR(255) NOT NULL
        , FILL5 VARCHAR(4) NOT NULL
    
    , CONSTRAINT LD_BCN_FND_LOCK_TP1 PRIMARY KEY(APPT_FNDLCK_USR_ID,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_COA_CD,UNIV_FISCAL_YR,FILL1)
...
# LD_BCN_II_INIT_MT
# -----------------------------------------------------------------------
drop table if exists LD_BCN_II_INIT_MT
/
...
(
      PERSON_UNVL_ID VARCHAR(40)
        , EMPLID VARCHAR(40)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , PERSON_NM VARCHAR(123)
        , SETID_SALARY VARCHAR(5)
        , SAL_ADMIN_PLAN VARCHAR(4)
        , GRADE VARCHAR(3)
        , IU_CLASSIF_LEVEL VARCHAR(2)
    
    , CONSTRAINT LD_BCN_II_INIT_MTP1 PRIMARY KEY(PERSON_UNVL_ID,EMPLID)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_INCUMBENT_SEL_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_INCUMBENT_SEL_TP1 PRIMARY KEY(PERSON_UNVL_ID,EMPLID,FIN_OBJECT_CD)
...
# LD_BCN_INTINCBNT_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_INTINCBNT_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_INTINCBNT_TP1 PRIMARY KEY(EMPLID)


    , INDEX LD_BCN_INTINCBNT_TI2 (PERSON_NM)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_LCK_PYRT_ACCT01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_LCK_PYRT_ACCT01_MTP1 PRIMARY KEY(SESID,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR)
...
# LD_BCN_LEVL_SUMM_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_LEVL_SUMM_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_LEVL_SUMM_TP1 PRIMARY KEY(PERSON_UNVL_ID,ORG_FIN_COA_CD,ORG_CD,SUB_FUND_GRP_CD,FIN_COA_CD,INC_EXP_CD,FIN_CONS_SORT_CD,FIN_LEV_SORT_CD)
...
# LD_BCN_MNTH_SUMM_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_MNTH_SUMM_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_MNTH_SUMM_TP1 PRIMARY KEY(PERSON_UNVL_ID,ORG_FIN_COA_CD,ORG_CD,SUB_FUND_GRP_CD,FIN_COA_CD,INC_EXP_CD,FIN_CONS_SORT_CD,FIN_LEV_SORT_CD,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)
...
# LD_BCN_OBJT_DUMP_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_OBJT_DUMP_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_OBJT_DUMP_TP1 PRIMARY KEY(PERSON_UNVL_ID,ORG_FIN_COA_CD,ORG_CD,SUB_FUND_GRP_CD,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD)
...
# LD_BCN_OBJT_SUMM_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_OBJT_SUMM_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_OBJT_SUMM_TP1 PRIMARY KEY(PERSON_UNVL_ID,ORG_FIN_COA_CD,ORG_CD,SUB_FUND_GRP_CD,FIN_COA_CD,INC_EXP_CD,FIN_CONS_SORT_CD,FIN_LEV_SORT_CD,FIN_OBJECT_CD)
...
# LD_BCN_OBJ_PICK_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_OBJ_PICK_T
/
...
(
      PERSON_UNVL_ID VARCHAR(40)
        , FIN_OBJECT_CD VARCHAR(4)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , SELECT_FLAG DECIMAL(7)
    
    , CONSTRAINT LD_BCN_OBJ_PICK_TP1 PRIMARY KEY(PERSON_UNVL_ID,FIN_OBJECT_CD)
...
# LD_BCN_ORG_RPTS_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_ORG_RPTS_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_ORG_RPTS_TP1 PRIMARY KEY(FIN_COA_CD,ORG_CD)

    , CONSTRAINT LD_BCN_ORG_RPTS_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_BCN_ORG_RPTS_TI2 (RPTS_TO_ORG_CD, RPTS_TO_FIN_COA_CD)
...
# LD_BCN_PAYRT_HLDG_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_PAYRT_HLDG_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_PAYRT_HLDG_TP1 PRIMARY KEY(PERSON_UNVL_ID,EMPLID,POSITION_NBR)
...
# LD_BCN_POS_FND_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_POS_FND_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_POS_FND_TP1 PRIMARY KEY(PERSON_UNVL_ID,SEL_ORG_FIN_COA,SEL_ORG_CD,PERSON_NM,EMPLID,POSITION_NBR,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)


    , INDEX LD_BCN_POS_FND_TI2 (UNIV_FISCAL_YR, FIN_COA_CD, ACCOUNT_NBR, SUB_ACCT_NBR, FIN_OBJECT_CD, FIN_SUB_OBJ_CD, POSITION_NBR, EMPLID)
...
# LD_BCN_POS_INIT_MT
# -----------------------------------------------------------------------
drop table if exists LD_BCN_POS_INIT_MT
/
...
(
      PERSON_UNVL_ID VARCHAR(40)
        ...
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , POS_EFFDT DATETIME
        , POS_EFF_STATUS VARCHAR(1)
        , POSN_STATUS VARCHAR(1)
        , BUDGETED_POSN VARCHAR(1)
        , CONFIDENTIAL_POSN VARCHAR(1)
        , POS_STD_HRS_DFLT DECIMAL(6,2)
        , POS_REG_TEMP VARCHAR(1)
        , POS_FTE DECIMAL(22,6)
        , IU_NORM_WORK_MONTHS DECIMAL(2)
        , IU_PAY_MONTHS DECIMAL(2)
        , POS_DESCR VARCHAR(30)
        , SETID_DEPT VARCHAR(5)
        , POS_DEPTID VARCHAR(10)
        , RC_CD VARCHAR(2)
        , POS_UNION_CD VARCHAR(3)
        , POS_SAL_PLAN_DFLT VARCHAR(4)
        , POS_GRADE_DFLT VARCHAR(3)
        , SETID_JOBCODE VARCHAR(5)
        , JOBCODE VARCHAR(6)
        , JBCD_DESCR VARCHAR(30)
        , SETID_SALARY VARCHAR(5)
        , IU_DFLT_OBJ_CD VARCHAR(4)
        , IU_POSITION_TYPE VARCHAR(2)
    
    , CONSTRAINT LD_BCN_POS_INIT_MTP1 PRIMARY KEY(PERSON_UNVL_ID,POSITION_NBR,UNIV_FISCAL_YR)
...
# LD_BCN_POS_SEL_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_POS_SEL_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_POS_SEL_TP1 PRIMARY KEY(PERSON_UNVL_ID,POSITION_NBR,UNIV_FISCAL_YR,EMPLID)


    , INDEX LD_BCN_POS_SEL_TI2 (POSITION_NBR, UNIV_FISCAL_YR)
...
# LD_BCN_POS_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_POS_T
/
...
(
      POSITION_NBR VARCHAR(8)
        ...
        , IU_DFLT_OBJ_CD VARCHAR(4)
        , IU_POSITION_TYPE VARCHAR(2)
        , POS_LOCK_USR_ID VARCHAR(40)
    
    , CONSTRAINT LD_BCN_POS_TP1 PRIMARY KEY(POSITION_NBR,UNIV_FISCAL_YR)


    , INDEX LD_BCN_POS_TI2 (POS_DEPTID, UNIV_FISCAL_YR)
...
# LD_BCN_PULLUP_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_PULLUP_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_PULLUP_TP1 PRIMARY KEY(PERSON_UNVL_ID,FIN_COA_CD,ORG_CD)
...
# LD_BCN_RQST_MT
# -----------------------------------------------------------------------
drop table if exists LD_BCN_RQST_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_RQST_MTP1 PRIMARY KEY(PERSON_UNVL_ID,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)
...
# LD_BCN_RSN_CD_PK_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_RSN_CD_PK_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_RSN_CD_PK_TP1 PRIMARY KEY(PERSON_UNVL_ID,APPT_FND_REASON_CD)
...
# LD_BCN_SAL_FND_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_SAL_FND_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_SAL_FND_TP1 PRIMARY KEY(PERSON_UNVL_ID,EMPLID,POSITION_NBR,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)


    , INDEX LD_BCN_SAL_FND_TI2 (UNIV_FISCAL_YR, FIN_COA_CD, ACCOUNT_NBR, SUB_ACCT_NBR, FIN_OBJECT_CD, FIN_SUB_OBJ_CD, POSITION_NBR, EMPLID)
...
# LD_BCN_SAL_SSN_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_SAL_SSN_T
/
...
(
    ...
    , CONSTRAINT LD_BCN_SAL_SSN_TP1 PRIMARY KEY(PERSON_UNVL_ID,ORG_FIN_COA_CD,ORG_CD,PERSON_NM,EMPLID)


    , INDEX LD_BCN_SAL_SSN_TI2 (EMPLID)
...
# LD_BCN_SLRY_TOT_T
# -----------------------------------------------------------------------
drop table if exists LD_BCN_SLRY_TOT_T
/
...
(
      PERSON_UNVL_ID VARCHAR(40)
        ...
        , APPT_RQST_FTE_QTY DECIMAL(22,6)
        , INIT_RQST_AMT DECIMAL(19,2)
        , INIT_RQST_FTE_QTY DECIMAL(22,6)
    
    , CONSTRAINT LD_BCN_SLRY_TOT_TP1 PRIMARY KEY(PERSON_UNVL_ID,ORG_FIN_COA_CD,ORG_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_SUBFUND_PICK_T
/
...
(
      PERSON_UNVL_ID VARCHAR(40)
        , SUB_FUND_GRP_CD VARCHAR(6)
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , REPORT_FLAG DECIMAL(7)
    
    , CONSTRAINT LD_BCN_SUBFUND_PICK_TP1 PRIMARY KEY(PERSON_UNVL_ID,SUB_FUND_GRP_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_UPDT_RQST01_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_UPDT_RQST01_MTP1 PRIMARY KEY(SESID,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD)
...
# -----------------------------------------------------------------------
drop table if exists LD_BCN_UPDT_RQST02_MT
/
...
(
    ...
    , CONSTRAINT LD_BCN_UPDT_RQST02_MTP1 PRIMARY KEY(SESID,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FDOC_NBR)
...
# LD_BENEFITS_CALC_T
# -----------------------------------------------------------------------
drop table if exists LD_BENEFITS_CALC_T
/
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        , FIN_COA_CD VARCHAR(2)
        , POS_BENEFIT_TYP_CD VARCHAR(2)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , POS_FRNG_BENE_PCT DECIMAL(7,4)
        , POS_FRNGBEN_OBJ_CD VARCHAR(4)
        , ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , LBR_BEN_RT_CAT_CD VARCHAR(2) default '--'
        , OFFSET_FIN_OBJECT_CD VARCHAR(4)
        , OFFSET_ACCOUNT_NBR VARCHAR(7)
    
    , CONSTRAINT LD_BENEFITS_CALC_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,POS_BENEFIT_TYP_CD)

    , CONSTRAINT LD_BENEFITS_CALC_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_BENEFITS_CALC_TI2 (UNIV_FISCAL_YR, FIN_COA_CD, POS_FRNGBEN_OBJ_CD)
...
# LD_BENEFITS_TYPE_T
# -----------------------------------------------------------------------
drop table if exists LD_BENEFITS_TYPE_T
/
...
(
      POS_BENEFIT_TYP_CD VARCHAR(2)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , POS_BENE_TYP_DESC VARCHAR(40)
        , POS_BENE_RETIRE_CD VARCHAR(1)
        , ACTV_IND VARCHAR(1) default 'Y' NOT NULL
    
    , CONSTRAINT LD_BENEFITS_TYPE_TP1 PRIMARY KEY(POS_BENEFIT_TYP_CD)
...
# LD_CSFTRCKR_OVRD_T
# -----------------------------------------------------------------------
drop table if exists LD_CSFTRCKR_OVRD_T
/
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        ...
        , POS_CSF_TM_PCT DECIMAL(22,6)
        , POS_CSF_FNDSTAT_CD VARCHAR(1)
        , POS_CSF_DELETE_CD VARCHAR(1)
        , ACTV_IND VARCHAR(1) default 'Y' NOT NULL
    
    , CONSTRAINT LD_CSFTRCKR_OVRD_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,POSITION_NBR,EMPLID)
...
# LD_CSF_TRACKER_T
# -----------------------------------------------------------------------
drop table if exists LD_CSF_TRACKER_T
/
...
(
    ...
    , CONSTRAINT LD_CSF_TRACKER_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,POSITION_NBR,EMPLID,POS_CSF_CREATE_TM)

    , CONSTRAINT LD_CSF_TRACKER_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_CSF_TRACKER_TI2 (EMPLID)
    , INDEX LD_CSF_TRACKER_TI4 (POSITION_NBR, UNIV_FISCAL_YR)
...
# LD_EXP_TRNFR_DOC_T
# -----------------------------------------------------------------------
drop table if exists LD_EXP_TRNFR_DOC_T
/
...
(
    ...
    , CONSTRAINT LD_EXP_TRNFR_DOC_TP1 PRIMARY KEY(FDOC_NBR)

    , CONSTRAINT LD_EXP_TRNFR_DOC_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_EXP_TRNFR_DOC_TI2 (EMPLID)
...
# LD_EXP_TRNFR_FRM_T
# -----------------------------------------------------------------------
drop table if exists LD_EXP_TRNFR_FRM_T
/
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , ORG_REFERENCE_ID VARCHAR(8)
        , POSITION_NBR VARCHAR(8)
        , PYRL_TOTAL_HR DECIMAL(8,2)
        , FDOC_OVERRIDE_CD VARCHAR(100)
        , PYRL_DT_FSCL_YR DECIMAL(4)
        , PYRL_DT_FSCLPRD_CD VARCHAR(2)
        , EMPLID VARCHAR(40)
    
    , CONSTRAINT LD_EXP_TRNFR_FRM_TP1 PRIMARY KEY(FDOC_NBR,FDOC_LINE_NBR)

    , CONSTRAINT LD_EXP_TRNFR_FRM_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_EXP_TRNFR_FRM_TI2 (FIN_COA_CD, ACCOUNT_NBR)
    , INDEX LD_EXP_TRNFR_FRM_TI3 (FDOC_POST_YR, FIN_COA_CD, FIN_OBJECT_CD)
    , INDEX LD_EXP_TRNFR_FRM_TI4 (FDOC_NBR)
...
# LD_EXP_TRNFR_TO_T
# -----------------------------------------------------------------------
drop table if exists LD_EXP_TRNFR_TO_T
/
...
(
    ...
    , CONSTRAINT LD_EXP_TRNFR_TO_TP1 PRIMARY KEY(FDOC_NBR,FDOC_LINE_NBR)

    , CONSTRAINT LD_EXP_TRNFR_TO_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_EXP_TRNFR_TO_TI2 (FDOC_NBR)
    , INDEX LD_EXP_TRNFR_TO_TI3 (FIN_COA_CD, ACCOUNT_NBR)
    , INDEX LD_EXP_TRNFR_TO_TI4 (FDOC_POST_YR, FIN_COA_CD, FIN_OBJECT_CD)
...
# LD_JRNL_VCHR_DOC_T
# -----------------------------------------------------------------------
drop table if exists LD_JRNL_VCHR_DOC_T
/
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , FDOC_REVERSAL_DT DATETIME
        , FIN_BALANCE_TYP_CD VARCHAR(2)
        , FDOC_OFST_TYP_CD VARCHAR(4)
    
    , CONSTRAINT LD_JRNL_VCHR_DOC_TP1 PRIMARY KEY(FDOC_NBR)
...
# LD_JRNL_VCHR_DTL_T
# -----------------------------------------------------------------------
drop table if exists LD_JRNL_VCHR_DTL_T
/
...
(
      FDOC_NBR VARCHAR(14)
        ...
        , FIN_OBJ_TYP_CD VARCHAR(2)
        , POSITION_NBR VARCHAR(8)
        , PAY_PERIOD_END_DT DATETIME
        , TRN_TOTAL_HR DECIMAL(9,2)
        , PYRL_DT_FSCL_YR DECIMAL(4)
        , PYRL_DT_FSCLPRD_CD VARCHAR(2)
        , EMPLID VARCHAR(40)
        , EMPL_RCD DECIMAL(3)
        ...
        , GRADE VARCHAR(3)
        , RUN_ID VARCHAR(10)
        , LL_ORIG_FIN_COA_CD VARCHAR(2)
        , LL_ORIG_ACCT_NBR VARCHAR(7)
        , LL_ORIG_SUB_ACCT_NBR VARCHAR(5)
        , LL_ORIG_FIN_OBJECT_CD VARCHAR(4)
        , LL_ORIG_FIN_SUB_OBJ_CD VARCHAR(3)
        , COMPANY VARCHAR(3)
        , SETID VARCHAR(5)
    
    , CONSTRAINT LD_JRNL_VCHR_DTL_TP1 PRIMARY KEY(FDOC_NBR,FDOC_LINE_NBR)
...
# LD_JULY1_POS_FND_T
# -----------------------------------------------------------------------
drop table if exists LD_JULY1_POS_FND_T
/
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , JULY1_BDGT_AMT DECIMAL(19,2)
        , JULY1_BDGT_FTE_QTY DECIMAL(22,6)
        , JULY1_BDGT_TM_PCT DECIMAL(22,6)
    
    , CONSTRAINT LD_JULY1_POS_FND_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,POSITION_NBR,EMPLID)
...
# LD_LABOR_OBJ_T
# -----------------------------------------------------------------------
drop table if exists LD_LABOR_OBJ_T
/
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        ...
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , DTL_POS_REQ_CD VARCHAR(1)
        , FIN_OBJ_HRS_REQ_CD VARCHAR(1)
        , FIN_OBJ_PAY_TYP_CD VARCHAR(1)
        , FINOBJ_FRNGSLRY_CD VARCHAR(1)
        , POS_OBJ_GRP_CD VARCHAR(2)
        , ACTV_IND VARCHAR(1) default 'Y' NOT NULL
    
    , CONSTRAINT LD_LABOR_OBJ_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,FIN_OBJECT_CD)
...
# LD_LBR_BFT_RT_CAT_T
# -----------------------------------------------------------------------
drop table if exists LD_LBR_BFT_RT_CAT_T
/
...
(
      LBR_BEN_RT_CAT_CD VARCHAR(2)
        ...
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , ACTV_IND VARCHAR(1) default 'Y'
        , LBR_BEN_RT_CAT_NM VARCHAR(40)
    
    , CONSTRAINT LD_LBR_BFT_RT_CAT_TP1 PRIMARY KEY(LBR_BEN_RT_CAT_CD)
...
# LD_LBR_GL_ENTRY_T
# -----------------------------------------------------------------------
drop table if exists LD_LBR_GL_ENTRY_T
/
...
(
    ...
    , CONSTRAINT LD_LBR_GL_ENTRY_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,FIN_BALANCE_TYP_CD,FIN_OBJ_TYP_CD,UNIV_FISCAL_PRD_CD,FDOC_TYP_CD,FS_ORIGIN_CD,FDOC_NBR,TRN_ENTR_SEQ_NBR)
...
# LD_LBR_OBJ_BENE_T
# -----------------------------------------------------------------------
drop table if exists LD_LBR_OBJ_BENE_T
/
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        , FIN_COA_CD VARCHAR(2)
        , FIN_OBJECT_CD VARCHAR(4)
        , FINOBJ_BENE_TYP_CD VARCHAR(2)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , ACTV_IND VARCHAR(1) default 'Y' NOT NULL
        , LBR_BEN_RT_CAT_CD VARCHAR(2)
    
    , CONSTRAINT LD_LBR_OBJ_BENE_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,FIN_OBJECT_CD,FINOBJ_BENE_TYP_CD)

    , CONSTRAINT LD_LBR_OBJ_BENE_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_LBR_OBJ_BENE_TI2 (UNIV_FISCAL_YR, FIN_COA_CD, FINOBJ_BENE_TYP_CD)
...
# LD_LDGR_BAL_HIST_T
# -----------------------------------------------------------------------
drop table if exists LD_LDGR_BAL_HIST_T
/
...
(
    ...
    , CONSTRAINT LD_LDGR_BAL_HIST_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,FIN_BALANCE_TYP_CD,FIN_OBJ_TYP_CD,POSITION_NBR,EMPLID)
...
# LD_LDGR_BAL_T
# -----------------------------------------------------------------------
drop table if exists LD_LDGR_BAL_T
/
...
(
    ...
    , CONSTRAINT LD_LDGR_BAL_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,FIN_BALANCE_TYP_CD,FIN_OBJ_TYP_CD,POSITION_NBR,EMPLID)

    , CONSTRAINT LD_LDGR_BAL_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_LDGR_BAL_TI2 (UNIV_FISCAL_YR, EMPLID, FIN_BALANCE_TYP_CD, FIN_OBJ_TYP_CD)
...
# LD_LDGR_ENTR_HIST_T
# -----------------------------------------------------------------------
drop table if exists LD_LDGR_ENTR_HIST_T
/
...
(
    ...
    , CONSTRAINT LD_LDGR_ENTR_HIST_TP1 PRIMARY KEY(UNIV_FISCAL_YR,UNIV_FISCAL_PRD_CD,FIN_COA_CD,FIN_OBJECT_CD,FIN_BALANCE_TYP_CD,TRN_DEBIT_CRDT_CD)
...
# LD_LDGR_ENTR_T
# -----------------------------------------------------------------------
drop table if exists LD_LDGR_ENTR_T
/
...
(
    ...
    , CONSTRAINT LD_LDGR_ENTR_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,FIN_BALANCE_TYP_CD,FIN_OBJ_TYP_CD,UNIV_FISCAL_PRD_CD,FDOC_TYP_CD,FS_ORIGIN_CD,FDOC_NBR,TRN_ENTR_SEQ_NBR)

    , CONSTRAINT LD_LDGR_ENTR_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_LDGR_ENTR_TI2 (UNIV_FISCAL_YR, FIN_COA_CD, ACCOUNT_NBR, SUB_ACCT_NBR, FIN_OBJECT_CD, FIN_SUB_OBJ_CD, FIN_BALANCE_TYP_CD, FIN_OBJ_TYP_CD, POSITION_NBR, EMPLID)
    , INDEX LD_LDGR_ENTR_TI3 (UNIV_FISCAL_YR, FIN_BALANCE_TYP_CD, UNIV_FISCAL_PRD_CD, ERNCD, PAYGROUP, SAL_ADMIN_PLAN)
...
# LD_PNDBC_APPTFND_T
# -----------------------------------------------------------------------
drop table if exists LD_PNDBC_APPTFND_T
/
...
(
      UNIV_FISCAL_YR DECIMAL(4)
        ...
        , APPT_FND_DLT_CD VARCHAR(1)
        , APPT_FND_MO DECIMAL(2)
        , POS_OBJ_CHG_IND VARCHAR(1)
        , POS_SAL_CHG_IND VARCHAR(1)
    
    , CONSTRAINT LD_PNDBC_APPTFND_TP1 PRIMARY KEY(UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,POSITION_NBR,EMPLID)

    , CONSTRAINT LD_PNDBC_APPTFND_TC0 UNIQUE (OBJ_ID)

    , INDEX LD_PNDBC_APPTFND_TI2 (FIN_COA_CD, ACCOUNT_NBR)
    , INDEX LD_PNDBC_APPTFND_TI3 (EMPLID)
    , INDEX LD_PNDBC_APPTFND_TI4 (POSITION_NBR, UNIV_FISCAL_YR)
...
# LD_PND_BCNSTR_GL_T
# -----------------------------------------------------------------------
drop table if exists LD_PND_BCNSTR_GL_T
/
...
(
    ...
    , CONSTRAINT LD_PND_BCNSTR_GL_TP1 PRIMARY KEY(FDOC_NBR,UNIV_FISCAL_YR,FIN_COA_CD,ACCOUNT_NBR,SUB_ACCT_NBR,FIN_OBJECT_CD,FIN_SUB_OBJ_CD,FIN_BALANCE_TYP_CD,FIN_OBJ_TYP_CD)


    , INDEX LD_PND_BCNSTR_GL_TI2 (UNIV_FISCAL_YR, FIN_COA_CD, FIN_OBJECT_CD)
    , INDEX LD_PND_BCNSTR_GL_TI3 (UNIV_FISCAL_YR, FIN_COA_CD, ACCOUNT_NBR, FIN_OBJECT_CD, FIN_SUB_OBJ_CD)
    , INDEX LD_PND_BCNSTR_GL_TI5 (FIN_COA_CD, ACCOUNT_NBR)
...
# LD_PND_LDGR_ENTR_T
# -----------------------------------------------------------------------
drop table if exists LD_PND_LDGR_ENTR_T
/
...
(
    ...
    , CONSTRAINT LD_PND_LDGR_ENTR_TP1 PRIMARY KEY(FS_ORIGIN_CD,FDOC_NBR,TRN_ENTR_SEQ_NBR)
...
# LD_POS_OBJ_GRP_T
# -----------------------------------------------------------------------
drop table if exists LD_POS_OBJ_GRP_T
/
...
(
      POS_OBJ_GRP_CD VARCHAR(2)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , POS_OBJ_GRP_NM VARCHAR(40)
        , ROW_ACTV_IND VARCHAR(1) NOT NULL
    
    , CONSTRAINT LD_POS_OBJ_GRP_TP1 PRIMARY KEY(POS_OBJ_GRP_CD)
...
# PS_POSITION_DATA
# -----------------------------------------------------------------------
drop table if exists PS_POSITION_DATA
/
...
(
      POSITION_NBR VARCHAR(8)
        ...
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , JOBCODE VARCHAR(6)
        , POS_EFF_STATUS VARCHAR(1) NOT NULL
        , DESCR VARCHAR(30) NOT NULL
        , DESCRSHORT VARCHAR(10) NOT NULL
        , BUSINESS_UNIT VARCHAR(5) NOT NULL
        , DEPTID VARCHAR(10) NOT NULL
        , POSN_STATUS VARCHAR(1) NOT NULL
        , STATUS_DT DATETIME
        , BUDGETED_POSN VARCHAR(1) NOT NULL
        , STD_HRS_DEFAULT DECIMAL(6,2) NOT NULL
        , STD_HRS_FREQUENCY VARCHAR(5) NOT NULL
        , POS_REG_TEMP VARCHAR(1) NOT NULL
        , POS_FTE DECIMAL(3,2) NOT NULL
        , POS_SAL_PLAN_DFLT VARCHAR(4) NOT NULL
        , POS_GRADE_DFLT VARCHAR(3) NOT NULL
    
    , CONSTRAINT PS_POSITION_DATAP1 PRIMARY KEY(POSITION_NBR,EFFDT)
...
(
    ...
    , INDEX PUR_REQS_TI3 (REQS_STAT_CD)
...
(
    ...
    , CONSTRAINT PUR_VNDR_ALIAS_TP1 PRIMARY KEY(VNDR_ALIAS_NM,VNDR_HDR_GNRTD_ID,VNDR_DTL_ASND_ID)
...
(
      VNDR_HDR_GNRTD_ID DECIMAL(10)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) default 1 NOT NULL
        , VNDR_TYP_CD VARCHAR(4) NOT NULL
...
WHERE C.UNIV_FISCAL_YR = S.UNIV_FISCAL_YR AND UNIV_DT = DATE(NOW())
)
...
# -----------------------------------------------------------------------
# END_KEMID_CRNT_BAL_DET_V
# -----------------------------------------------------------------------
drop view if exists END_KEMID_CRNT_BAL_DET_V
/
...
# -----------------------------------------------------------------------
# END_KEMID_CRNT_BAL_V
# -----------------------------------------------------------------------
drop view if exists END_KEMID_CRNT_BAL_V
/
...
# -----------------------------------------------------------------------
# END_KEMID_CRNT_REP_GRP_V
# -----------------------------------------------------------------------
drop view if exists END_KEMID_CRNT_REP_GRP_V
/
CREATE VIEW END_KEMID_CRNT_REP_GRP_V AS 
select
C.KEMID,
CL.SEC_RPT_GRP,
C.sec_id,
...
from END_CRNT_TAX_LOT_BAL_T C, END_SEC_T S, END_CLS_CD_T CL
where C.sec_id = S.sec_id
and s.SEC_CLS_CD = CL.SEC_CLS_CD
group by C.KEMID, CL.SEC_RPT_GRP, C.HLDG_IP_IND, C.sec_id, C.regis_cd
...
# -----------------------------------------------------------------------
# END_KEMID_HIST_BAL_DET_V
# -----------------------------------------------------------------------
drop view if exists END_KEMID_HIST_BAL_DET_V
/
CREATE VIEW END_KEMID_HIST_BAL_DET_V AS 
SELECT
    B.kemid
    , B.hldg_ip_ind
    ,
...
# -----------------------------------------------------------------------
# END_KEMID_HIST_BAL_V
# -----------------------------------------------------------------------
drop view if exists END_KEMID_HIST_BAL_V
/
...
# -----------------------------------------------------------------------
# END_KEMID_HIST_REP_GRP_V
# -----------------------------------------------------------------------
drop view if exists END_KEMID_HIST_REP_GRP_V
/
...
# A21_LBR_BLD_NBR_SEQ
# -----------------------------------------------------------------------
drop table if exists A21_LBR_BLD_NBR_SEQ
/

CREATE TABLE A21_LBR_BLD_NBR_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE A21_LBR_BLD_NBR_SEQ auto_increment = 2000
/
...
/
ALTER TABLE CA_A21_ICR_ACCT_SEQ auto_increment = 10020
/
...
# -----------------------------------------------------------------------
# CA_ACCT_AUTO_CREATE_DFLT_SEQ
# -----------------------------------------------------------------------
drop table if exists CA_ACCT_AUTO_CREATE_DFLT_SEQ
/

CREATE TABLE CA_ACCT_AUTO_CREATE_DFLT_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE CA_ACCT_AUTO_CREATE_DFLT_SEQ auto_increment = 1
/
...
/
ALTER TABLE CA_ICR_ACCT_SEQ auto_increment = 12280
/

# -----------------------------------------------------------------------
# CB_ACTN_ID_SEQ
# -----------------------------------------------------------------------
drop table if exists CB_ACTN_ID_SEQ
/

CREATE TABLE CB_ACTN_ID_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE CB_ACTN_ID_SEQ auto_increment = 2000
/

# -----------------------------------------------------------------------
# CB_GL_ACCT_ID_SEQ
# -----------------------------------------------------------------------
drop table if exists CB_GL_ACCT_ID_SEQ
/

CREATE TABLE CB_GL_ACCT_ID_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE CB_GL_ACCT_ID_SEQ auto_increment = 2000
/
...
# -----------------------------------------------------------------------
# CM_AST_PMT_DOC_TYP_SEQ
# -----------------------------------------------------------------------
drop table if exists CM_AST_PMT_DOC_TYP_SEQ
/

CREATE TABLE CM_AST_PMT_DOC_TYP_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE CM_AST_PMT_DOC_TYP_SEQ auto_increment = 20
/
...
# END_ACI_SEQ
# -----------------------------------------------------------------------
drop table if exists END_ACI_SEQ
/

CREATE TABLE END_ACI_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE END_ACI_SEQ auto_increment = 1
/

# -----------------------------------------------------------------------
# END_CASH_SWEEP_SEQ
# -----------------------------------------------------------------------
drop table if exists END_CASH_SWEEP_SEQ
/

CREATE TABLE END_CASH_SWEEP_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE END_CASH_SWEEP_SEQ auto_increment = 1
/

# -----------------------------------------------------------------------
# END_KEMID_SEQ
# -----------------------------------------------------------------------
drop table if exists END_KEMID_SEQ
/
...
# END_REC_CSH_XFR_SEQ
# -----------------------------------------------------------------------
drop table if exists END_REC_CSH_XFR_SEQ
/

CREATE TABLE END_REC_CSH_XFR_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
...
# END_TKLR_SEQ
# -----------------------------------------------------------------------
drop table if exists END_TKLR_SEQ
/
...
/
ALTER TABLE FP_PRCRMNT_CARD_TRN_MT_SEQ auto_increment = 2040
/
...
/
ALTER TABLE KRNS_DOC_TYP_ATTR_S auto_increment = 1580
/
...
/
ALTER TABLE KRNS_LOOKUP_RSLT_S auto_increment = 2040
/
...
/
ALTER TABLE KRNS_NTE_S auto_increment = 2060
/
...
/
ALTER TABLE KRSB_BAM_PARM_S auto_increment = 30000
/
...
/
ALTER TABLE KRSB_BAM_S auto_increment = 30000
/
...
/
ALTER TABLE KRSB_MSG_QUE_S auto_increment = 30000
/
...
/
ALTER TABLE PO_CONTR_LANG_ID auto_increment = 1007
/
...
# -----------------------------------------------------------------------
drop table if exists SEC_SCRTY_DEFN_ID_SEQ
/

CREATE TABLE SEC_SCRTY_DEFN_ID_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE SEC_SCRTY_DEFN_ID_SEQ auto_increment = 1
/

# -----------------------------------------------------------------------
# SEC_SCRTY_MDL_DEFN_ID_SEQ
# -----------------------------------------------------------------------
drop table if exists SEC_SCRTY_MDL_DEFN_ID_SEQ
/

CREATE TABLE SEC_SCRTY_MDL_DEFN_ID_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE SEC_SCRTY_MDL_DEFN_ID_SEQ auto_increment = 1
/

# -----------------------------------------------------------------------
# SEC_SCRTY_MDL_ID_SEQ
# -----------------------------------------------------------------------
drop table if exists SEC_SCRTY_MDL_ID_SEQ
/

CREATE TABLE SEC_SCRTY_MDL_ID_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE SEC_SCRTY_MDL_ID_SEQ auto_increment = 1
/

# -----------------------------------------------------------------------
# SEC_SCRTY_PRNCPL_DEFN_ID_SEQ
# -----------------------------------------------------------------------
drop table if exists SEC_SCRTY_PRNCPL_DEFN_ID_SEQ
/

CREATE TABLE SEC_SCRTY_PRNCPL_DEFN_ID_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE SEC_SCRTY_PRNCPL_DEFN_ID_SEQ auto_increment = 1
/
...
/
ALTER TABLE VNDR_ADDR_GNRTD_ID auto_increment = 12105
/
...
/
ALTER TABLE VNDR_HDR_GNRTD_ID auto_increment = 12105
/
