 ...
 * limitations under the License.
 ...
 Adapted from the source code freely available, without license at http://nelz.net/2008/04/08/log4j-runtime-configuration/
 
 TODO list:
 	* Add the ability to add category wildcards, such as edu.arizona.*
 	* Remove hard-coded categories from log4jproperties
 	* Adjust logging levels in code
 	* Add the ability to remove socket-based appenders at runtime
 	* Add the ability to add socket-based appenders at runtime
...
<div class="filterForm">
    ...
    <form action="logging.jsp" name="logFilterForm">Filter Loggers:&nbsp;&nbsp;
        ...
        <td class="center">
            <%
                for (int cnt = 0; cnt < logLevels.length; cnt++) {
                    ...
                    String url = "logging.jsp?operation=changeLogLevel&logger=" + loggerName + "&newLogLevel=" + logLevels[cnt] + "&logNameFilter=" + (logNameFilter != null ? logNameFilter : "") + "&logNameFilterType=" + (logNameFilterType != null ? logNameFilterType : "");
